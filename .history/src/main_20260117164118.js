        ...
        if (materials.size > 0) {
            ...
            materials.forEach((material, name) => {
                ...
                if (name.toUpperCase() === 'SKIN') {
                    // Auto-apply settings based on WordPress setting
                    if (window.flexframeSettings) {
                        ...
                        if (mode === 'custom' && window.flexframeSettings.skinSettings) {
                            console.log('Auto-applying Custom SKIN settings...');
                            setTimeout(() => this.applyCustomSkinSettings(window.flexframeSettings.skinSettings), 100);
                            ...
                            if (preset === 'preset1') {
                                console.log('Auto-applying Preset 1 (Refraction)...');
                                setTimeout(() => this.applyMaterialPreset1(), 100);
                            } else if (preset === 'wp_preset') {
                                console.log('Auto-applying WP Preset...');
                                setTimeout(() => this.applyWPPreset(), 100);
                            }
                        }
                    }
                }
            ...
            if (child.isMesh && child.material) {
                ...
                mats.forEach(mat => {
                    if (mat.name && presets[mat.name.toUpperCase()]) {
                        ...
                        // Remove color map to ensure pure color from preset
                        mat.map = null;
