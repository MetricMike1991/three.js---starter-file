...
class ThreeJSApp {
    ...
    showModelInspector(model, modelUrl) {
        ...
        const themeMappedNames = {
            ...
            'CLEARFEMALE': { section: 'Preset Only' },
                        ...
                        if (child.material) {
                            ...
                            mats.forEach(mat => {
                                if (mat.name) {
                                    ...
                                    // Convert MUSCLE materials to MeshPhysicalMaterial (pure material, textures stripped)
                                    ...
                                    // Convert CLEARFEMALE materials to MeshPhysicalMaterial (pure material, textures stripped)
                                    else if (mat.name.toUpperCase() === 'CLEARFEMALE' && mat.type !== 'MeshPhysicalMaterial') {
                                        if (convertedMaterials.has(mat.name)) {
                                            newMats.push(convertedMaterials.get(mat.name));
                                        } else {
                                            console.log(`Converting ${mat.name} to MeshPhysicalMaterial (pure material, no textures)`);
