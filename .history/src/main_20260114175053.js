                                    ...
                                    // Convert SKIN materials to MeshPhysicalMaterial for advanced transparency
                                        ...
                                        if (convertedMaterials.has(mat.name)) {
                                            ...
                                            const physicalMat = new THREE.MeshPhysicalMaterial({
                                                ...
                                                emissiveMap: mat.emissiveMap,
                                                opacity: 0.279, // Sketchfab opacity value
                                                transparent: true,
                                                side: THREE.DoubleSide,
                                                depthWrite: false,
                                                depthTest: true,
                                                // Refraction/transmission properties (Sketchfab "Refraction" mode)
                                                transmission: 0.721, // Inverse of opacity for glass effect
                                                thickness: 1.0,
                                                ior: 1.0, // Sketchfab IOR value (air = 1.0)
