...
import { RightMenuSystem, RightMenuSettingsController } from './js/right-menu-system.js';
...
class ThreeJSApp {
    ...
    async init() {
        ...
        // Initialize right menu settings controller
        this.rightMenuSettingsController = new RightMenuSettingsController(this.rightMenuSystem);
