...
// --- Smooth camera position and target transition on double-click, cancelable by user interaction ---
...
function cancelCameraLerp() {
    camLerpActive = false;
}

// Cancel transition on user interaction
canvas.addEventListener('mousedown', cancelCameraLerp);
canvas.addEventListener('wheel', cancelCameraLerp);
canvas.addEventListener('touchstart', cancelCameraLerp);
