...
const groundGeometry = new THREE.PlaneGeometry(30, 30); // Large for infinite effect
const solidGroundMaterial = new THREE.MeshStandardMaterial({ color: 0x222222, roughness: 1, metalness: 0, alphaMap: fadeTexture, transparent: true });
...
const ground = new THREE.Mesh(groundGeometry, solidGroundMaterial);
