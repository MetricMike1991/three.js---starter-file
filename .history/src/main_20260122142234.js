...
class ThreeJSApp {
    ...
    applyWordPressUISettings() {
        ...
        const spinnerColor = uiSettings.spinnerColor || primaryColor || '#4a9eff';
        this.updateSpinnerColor(spinnerColor);
        console.log('[FlexFrame UI] Spinner color set to:', spinnerColor, '(primary:', primaryColor, ')');
    }
    ...
    updateSpinnerColor(color) {
        ...
        style.textContent = `
            ...
            .logo-progress-text {
                color: ${hexToRgba(color, 0.9)} !important;
            }
