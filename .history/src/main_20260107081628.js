...
class ThreeJSApp {
    ...
    async init() {
        ...
        // Initialize screenshot manager after scene is fully set up
        ...
        // Initialize screenshot manager after everything is set up
        ...
        // Register screenshot manager with settings system
    ...
    setupGUI() {
        ...
        // Screenshot controls - setup after screenshot manager is initialized
        setTimeout(() => {
