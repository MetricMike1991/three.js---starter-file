...
class ThreeJSApp {
    ...
    createScreenshotPanel() {
            ...
            <div class="screenshot-panel-content">
                <div class="ss-group collapsed" data-group="screenshot">
                    ...
                    <div class="ss-group-body">
                        ...
                        <div class="screenshot-row">
                            <label>WebM Quality</label>
                            <select id="ss-video-quality">
                        ...
                        <div class="screenshot-buttons">
                            ...
                            <button class="ss-btn ss-video">Record WebM</button>
                        </div>
        ...
        panel.querySelector('.ss-video').addEventListener('click', () => {
            panel.querySelector('#ss-width').value = 2500;
            panel.querySelector('#ss-height').value = 2500;
            panel.querySelector('#ss-video-quality').value = 'ultra';
            this.updateScreenshotFramePanel(2500, 2500);
    ...
    async recordCustomVideo() {
        ...
        const width = parseInt(this.screenshotPanel?.querySelector('#ss-width')?.value) || 800;
        const height = parseInt(this.screenshotPanel?.querySelector('#ss-height')?.value) || 800;
        const baseFilename = this.screenshotPanel?.querySelector('#ss-filename')?.value || 'video';
        const showFloorShadow = this.screenshotPanel?.querySelector('#ss-floor-shadow')?.checked || false;
        const videoQuality = this.screenshotPanel?.querySelector('#ss-video-quality')?.value || 'high';
        const videoLoops = parseInt(this.screenshotPanel?.querySelector('#ss-video-loops')?.value) || 1;
