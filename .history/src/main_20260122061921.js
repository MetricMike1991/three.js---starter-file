...
class ThreeJSApp {
    ...
    updateLoadProgress(percent) {
        ...
        const progressOverlay = document.getElementById('logo-progress-overlay');
        ...
        if (percent === -1) {
            ...
            if (progressOverlay) {
                progressOverlay.style.clipPath = 'inset(50% 0 0 0)';
            }
        } else {
            ...
            if (progressOverlay) {
                // Reveal logo from bottom to top as progress increases
                const remaining = 100 - percent;
                progressOverlay.style.clipPath = `inset(0 0 ${percent}% 0)`;
            }
        }
    }
