    ...
    setupScreenshotGUI() {
        ...
        const quickActions = {
            ...
            toggleTransparent: () => {
                ...
                // Update the GUI toggle to reflect the change
                const transparentController = this.gui.controllers.find(c => c.property === 'transparent');
                if (transparentController) transparentController.updateDisplay();
            },
            autoFrameThumbnail: () => {
