                        ...
                        if (child.material) {
                            ...
                            mats.forEach(mat => {
                                if (mat.name) {
                                    ...
                                    // Convert MUSCLE materials to MeshPhysicalMaterial for clearcoat support
                                    if (mat.name.includes('MUSCLE') && mat.type !== 'MeshPhysicalMaterial') {
                                        console.log(`Converting ${mat.name} to MeshPhysicalMaterial for clearcoat support`);
