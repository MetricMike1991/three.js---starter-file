...
class ThreeJSApp {
    ...
    createScreenshotPanel() {
        ...
        style.textContent = `
            ...
            .ss-vid-adv-toggle:hover { opacity: 0.85; }
            details[open] .ss-vid-adv-toggle { opacity: 0.75; }
            .ss-vid-adv-body {
                display: flex;
                flex-direction: column;
                gap: 5px;
            ...
            .ss-vid-pan-deg option { background: #1a1a2e; }
            .ss-vid-dir-toggle {
                display: flex;
                flex: 1;
                gap: 3px;
    ...
    async recordCustomVideo() {
        ...
        const capturedAngles = (this._videoAngles || []).map((a, i) => {
            ...
            return { ...a, panDegrees: panDeg, panDirection: panDir };
        }).filter(a => a !== null);
        if (status) {
