...
class ThreeJSApp {
    ...
    applyWordPressSceneSettings() {
        ...
        // Apply Lighting Settings from WordPress
        if (window.flexframeSettings?.lightingSettings) {
            ...
            if (this.lightingSystem) {
                this.lightingSystem.applySettings(lightSettings);
            }
        }
        
        // Apply Particle Settings from WordPress
        if (window.flexframeSettings?.particleSettings) {
