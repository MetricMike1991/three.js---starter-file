                        ...
                        <div class="te-section te-nested">
                            ...
                            <div class="te-section-content" id="section-ui-spinner">
                                ...
                                <div class="te-row">
                                    ...
                                    <select data-setting="logoAnimation" style="width: 100%; padding: 8px; background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.2); border-radius: 4px; color: white;">
                                        <option value="pulse">Pulse (Grow & Shrink)</option>
                ...
                if (isHidden) {
                    if (isNested) {
                        ...
                        if (section === 'ui-player') {
                            ...
                            // Show side menus
                            const menus = document.querySelectorAll('.thumbnail-menu-wrapper');
                    ...
                    if (isNested) {
                        if (section === 'ui-player') {
                            ...
                            const menus = document.querySelectorAll('.thumbnail-menu-wrapper');
                            menus.forEach(menu => {
                                if (!menu.classList.contains('te-pinned')) {
