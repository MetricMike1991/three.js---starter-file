...
export class AnimationPlayer {
    ...
    initializeScaling() {
        // Base width for reference (typical desktop width)
        this.baseWidth = 1920;
    ...
    updatePlayerScale() {
        ...
        // Also respect the screen-size based scaling (but cap it)
        const screenScaleFactor = currentWidth / this.baseWidth;
        scaleFactor = Math.min(scaleFactor, screenScaleFactor);
        ...
        console.log(`Screen-based scale: ${screenScaleFactor.toFixed(3)}`);
