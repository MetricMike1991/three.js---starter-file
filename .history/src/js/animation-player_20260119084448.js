...
export class AnimationPlayer {
    ...
    showPlayer() {
        ...
        console.log('[AnimationPlayer] showPlayer called, classes:', this.container.className);
    ...
    hidePlayer() {
        ...
        console.log('[AnimationPlayer] hidePlayer called, classes:', this.container.className);
    }
    
    scheduleHide() {
        this.clearHideTimeout();
        console.log('[AnimationPlayer] scheduleHide called, will hide in 2 seconds');
        this.hideTimeout = setTimeout(() => {
            // Only hide if not being hovered
            if (!this.container.matches(':hover')) {
                this.hidePlayer();
            } else {
                console.log('[AnimationPlayer] Not hiding - mouse is hovering');
            }
    ...
    startStartupFade() {
        ...
        // Set fade timeout for 2 seconds (same as interaction timeout)
        this.hideTimeout = setTimeout(() => {
    ...
    setAlwaysVisible(alwaysVisible) {
        ...
        if (alwaysVisible) {
            ...
            this.container.classList.remove('always-visible');
            // If not always visible, start the hide countdown
            if (this.isVisible) {
                this.scheduleHide();
            }
        }
        
        console.log('[AnimationPlayer] After setAlwaysVisible, classes:', this.container.className);
    }
