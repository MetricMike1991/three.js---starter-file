...
export class AnimationPlayer {
    ...
    updatePlayerScale() {
        ...
        // Calculate scale factor (linear scaling between min and max)
        let scaleFactor = currentWidth / this.baseWidth;
        ...
        console.log(`Player container rect:`, {
        ...
        console.log(`Base width: ${this.baseWidth}px`);
        console.log(`Raw scale calculation: ${currentWidth} / ${this.baseWidth} = ${(currentWidth / this.baseWidth).toFixed(3)}`);
        console.log(`Clamped scale factor: ${scaleFactor.toFixed(3)} (min: ${this.minScale}, max: ${this.maxScale})`);
        console.log(`Applied transform: translateY(${this.container.classList.contains('visible') ? '0' : '100%'}) scale(${scaleFactor})`);
        console.log('==================');
    }
