    ...
    updateBackgroundLogo(params) {
        ...
        textureLoader.load(params.url, (texture) => {
            ...
            const material = new THREE.SpriteMaterial({
                ...
                depthTest: true,
                depthWrite: false,
                sizeAttenuation: true // Scale with distance like regular 3D objects
            });
            ...
            // Position in the background - far back on Z axis but in front of scene background
            // Position it behind where models typically are (models are usually around z=0)
            const yPos = params.yPosition !== undefined ? params.yPosition : 0.8;
            this.bgLogoSprite.position.set(0, yPos, -5);
            console.log('[SceneManager] Sprite position set to:', 0, yPos, -5);
            
            // Lower render order to render before other objects but after background
            this.bgLogoSprite.renderOrder = -100;
