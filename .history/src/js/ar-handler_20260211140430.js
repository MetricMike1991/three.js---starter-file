...
export class ARHandler {
    ...
    launchAndroidAR() {
        ...
        // NOTE: glbUrl already has %20 from the JSON config.
        // encodeURIComponent will encode %20 → %2520, but Scene Viewer
        // decodes one level, so it gets back %20, which CDN handles correctly.
        // This is the exact same pattern that worked in v33.
        ...
        // Use Google's Scene Viewer intent via Google Search app (same as v33)
    ...
    generateARPageUrl() {
        ...
        // TEMPORARY TEST: hardcode monkey2.glb to test AR without config dependency
        const glbUrl = 'https://FlexFrame.b-cdn.net/monkey2.glb';
        const usdzUrl = this.currentConfig?.ar?.usdz;
