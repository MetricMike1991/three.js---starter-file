            ...
            case 'exercises':
                ...
                if (window.menuManager && window.menuManager.selectedMuscle) {
                    this.filteredData = this.allExercises.filter(exercise => 
                        exercise.information?.primaryMuscle === window.menuManager.selectedMuscle
                    );
                    console.log(`Filtering exercises by primary muscle: ${window.menuManager.selectedMuscle}, found ${this.filteredData.length} exercises`);
                }
