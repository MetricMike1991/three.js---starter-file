...
class CameraManager {
    constructor(canvas, sizes) {
        ...
        this.originalTarget = new THREE.Vector3(0.013654, 0.400000, 0.051000);
        ...
        this.originalPosition = new THREE.Vector3(-0.9590035301193953, 0.8419997276175365, -0.8628049321969481);
        this.originalRotation = { x: -2.6910767143795984, y: -0.7640555193215852, z: -2.8186624298940703 };
    ...
    init() {
        ...
        this.camera.position.set(-0.9590035301193953, 0.8419997276175365, -0.8628049321969481);
        this.camera.rotation.set(-2.6910767143795984, -0.7640555193215852, -2.8186624298940703, 'XYZ');
        ...
        this.controls.target.set(0.013654, 0.400000, 0.051000);
