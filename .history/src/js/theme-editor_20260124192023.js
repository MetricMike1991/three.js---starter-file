...
class ThemeEditor {
    ...
    loadCurrentSettings() {
        ...
        this.currentSettings = {
            ...
            logoAnimation: ws.uiSettings?.logoLoaderAnimation || 'pulse',
                    ...
                    <div class="te-section-content" id="section-ui">
                        ...
                        <div class="te-section te-nested">
                            ...
                            <div class="te-section-content" id="section-ui-spinner">
                                ${this.createCheckboxInput('useLogoLoader', 'Use Logo Instead of Spinner')}
                                ${this.createColorInput('spinnerColor', 'Spinner Color')}
                                <div class="te-row">
                                    <label>Animation Style</label>
                                    <select data-setting="logoAnimation" style="width: 100%; padding: 8px; background: rgba(40,40,50,0.95); border: 1px solid rgba(255,255,255,0.3); border-radius: 4px; color: #ffffff; cursor: pointer;">
                                        <option value="pulse" style="background: #2a2a35; color: #ffffff;">Pulse (Grow & Shrink)</option>
                                        <option value="spin" style="background: #2a2a35; color: #ffffff;">Spin</option>
                                        <option value="fade" style="background: #2a2a35; color: #ffffff;">Fade</option>
                                        <option value="bounce" style="background: #2a2a35; color: #ffffff;">Bounce</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="te-section te-nested">
                            ...
                            <div class="te-section-content" id="section-ui-player">
                                <button class="te-preview-toggle" data-preview="player" style="width: 100%; padding: 10px; margin-bottom: 12px; background: #4CAF50; color: white; border: none; border-radius: 6px; cursor: pointer; font-weight: bold;">
                                    👁️ Show Bottom Menu Preview
                                </button>
                        ...
                        <div class="te-section te-nested">
                            ...
                            <div class="te-section-content" id="section-ui-menu">
                                <button class="te-preview-toggle" data-preview="menus" style="width: 100%; padding: 10px; margin-bottom: 12px; background: #4CAF50; color: white; border: none; border-radius: 6px; cursor: pointer; font-weight: bold;">
                                    👁️ Show Side Menus Preview
                                </button>
                ...
                if (previewType === 'player') {
                    ...
                    if (player) {
                        if (isShowing) {
                            ...
                            btn.textContent = '👁️ Show Bottom Menu Preview';
                    ...
                    if (isShowing) {
                        ...
                        btn.textContent = '👁️ Show Side Menus Preview';
                        btn.style.background = '#4CAF50';
                        btn.classList.remove('active');
                    } else {
