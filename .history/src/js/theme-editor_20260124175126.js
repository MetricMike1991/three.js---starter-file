...
class ThemeEditor {
    ...
    setupEventListeners() {
        ...
        // Section toggles - ACCORDION behavior (only one section open at a time)
        this.panel.querySelectorAll('.te-section-header').forEach(header => {
            header.addEventListener('click', () => {
                ...
                if (isHidden) {
                    ...
                    this.panel.querySelectorAll('.te-toggle-icon').forEach(otherIcon => {
