...
class CameraManager {
    constructor(canvas, sizes) {
        ...
        this.zoomDecay = 0.98;  // User's preferred decay
        this.zoomMomentumThreshold = 0.053;  // User's preferred threshold
    ...
    init() {
        ...
        this.controls.minDistance = 0.132;  // User's preferred close zoom
        this.controls.maxDistance = 380;    // User's preferred far zoom
