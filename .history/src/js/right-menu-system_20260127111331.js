...
export class RightMenuSystem {
    ...
    updateFromConfig(configTabs) {
        ...
        // Debug: Check info button before update
        const infoBtn = document.getElementById('infoToggle');
        if (infoBtn) {
            console.log('[RightMenu DEBUG] BEFORE updateFromConfig - Info button:', infoBtn);
            console.log('[RightMenu DEBUG] BEFORE - Button visible:', window.getComputedStyle(infoBtn).display);
            console.log('[RightMenu DEBUG] BEFORE - SVG:', infoBtn.querySelector('svg'));
            console.log('[RightMenu DEBUG] BEFORE - SVG fill:', infoBtn.querySelector('svg')?.getAttribute('fill'));
        }
        ...
        // Debug: Check info button after update
        if (infoBtn) {
            console.log('[RightMenu DEBUG] AFTER updateFromConfig - Info button:', infoBtn);
            console.log('[RightMenu DEBUG] AFTER - Button visible:', window.getComputedStyle(infoBtn).display);
            console.log('[RightMenu DEBUG] AFTER - SVG:', infoBtn.querySelector('svg'));
            console.log('[RightMenu DEBUG] AFTER - SVG fill:', infoBtn.querySelector('svg')?.getAttribute('fill'));
            console.log('[RightMenu DEBUG] AFTER - SVG path fill:', infoBtn.querySelector('svg path')?.getAttribute('fill'));
        }
    }
