...
class ThumbnailDropdownMenu {
    ...
    updateVirtualizedContent() {
        ...
        if (scrollTop <= 10) {
            // Very near top - jump to bottom of middle section
            this.scrollContainer.scrollTop = scrollTop + (sectionHeight * 2);
            adjustedScrollTop = this.scrollContainer.scrollTop;
        } else if (scrollTop < sectionHeight * 0.05) {
            // Near top - jump to second copy
            this.scrollContainer.scrollTop = scrollTop + sectionHeight;
            adjustedScrollTop = this.scrollContainer.scrollTop;
        } else if (scrollTop >= totalVirtualHeight - 10) {
            // Very near bottom - jump to top of middle section  
            this.scrollContainer.scrollTop = scrollTop - (sectionHeight * 2);
            adjustedScrollTop = this.scrollContainer.scrollTop;
        } else if (scrollTop > sectionHeight * 2.95) {
