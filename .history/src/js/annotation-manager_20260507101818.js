 ...
 *
 * Logged-in users can Shift+click the model to place a new marker.
...
export class AnnotationManager {
    ...
    init(renderer, camera, container) {
        ...
        // Shift+click on canvas → place annotation (logged-in only)
        if (this.isLoggedIn) {
            renderer.domElement.addEventListener('click', (e) => {
                if (e.shiftKey) this._onShiftClick(e);
            });
        }
