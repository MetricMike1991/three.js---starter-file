...
export class RightMenuSystem {
    ...
    // Mobile toggle methods - disabled, using hamburger menu instead
    createMobileToggleButton(menuContainer) {
        // Hamburger menu is handled by multi-thumbnail-menu.js
        // Don't create separate toggle buttons
    }

    updateMobileToggleVisibility() {
        // Handled by hamburger menu
    }
