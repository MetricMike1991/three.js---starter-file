            ...
            input.addEventListener('input', (e) => {
                ...
                if (e.target.type === 'checkbox') {
                    ...
                    if (key === 'useLogoLoader') {
                        ...
                        const logoLoader = loadingOverlay?.querySelector('.cool-loader');
                        const spinner = loadingOverlay?.querySelector('.spinner-box');
                        
                        console.log('[Theme Editor] Logo toggle:', value, 'Found elements:', { loadingOverlay, logoLoader, spinner });
                        
                        if (loadingOverlay) {
                            if (value) {
                                // Show logo, hide spinner
                                if (logoLoader) logoLoader.style.display = 'block';
