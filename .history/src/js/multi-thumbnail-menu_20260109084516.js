...
class ThumbnailDropdownMenu {
    ...
    updateVirtualizedContent() {
        ...
        // Render items using virtual index range, always in order
        for (let virtualIndex = this.startIndex; virtualIndex < this.endIndex; virtualIndex++) {
            ...
            // Create new element (always, to ensure order)
        ...
        // Always clear and re-append the fragment to maintain correct DOM order
