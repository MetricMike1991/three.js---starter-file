...
class ThemeEditor {
    constructor(app) {
        ...
        this.currentSettings = {
            ...
            particlesSpeed: 0.5,
            // Mobile UI Settings
            mobileFontSizeTitle: 10,
            mobileFontSizeText: 9,
            mobileInfoBgColor: '#0516ff',
            mobileInfoBgOpacity: 0.13,
            mobileInfoBlur: 10
        };
    ...
    loadCurrentSettings() {
        ...
        this.currentSettings = {
            ...
            // Mobile UI Settings
            mobileFontSizeTitle: ws.mobileSettings?.fontSizeTitle ?? 10,
            mobileFontSizeText: ws.mobileSettings?.fontSizeText ?? 9,
            mobileInfoBgColor: ws.mobileSettings?.infoBgColor || ws.uiSettings?.menu?.accentColor || '#0516ff',
            mobileInfoBgOpacity: ws.mobileSettings?.infoBgOpacity ?? 0.13,
            mobileInfoBlur: ws.mobileSettings?.infoBlur ?? 10
        };
                    ...
                    <div class="te-section-content" id="section-mobile">
                        ...
                        <div class="te-section te-nested">
                            ...
                            <div class="te-section-content" id="section-mobile-info">
                                ...
                                ${this.createRangeInput('mobileInfoBgOpacity', 'Background Opacity', 0, 1, 0.01)}
    ...
    async saveTheme() {
        ...
        const presetData = {
            ...
            // Mobile UI Settings
            mobile_font_size_title: this.currentSettings.mobileFontSizeTitle,
            mobile_font_size_text: this.currentSettings.mobileFontSizeText,
            mobile_info_bg_color: this.currentSettings.mobileInfoBgColor,
            mobile_info_bg_opacity: this.currentSettings.mobileInfoBgOpacity,
            mobile_info_blur: this.currentSettings.mobileInfoBlur
        };
