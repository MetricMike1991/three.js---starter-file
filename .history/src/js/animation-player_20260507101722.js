...
export class AnimationPlayer {
        ...
        this.container.innerHTML = `
            <div class="player-controls">
                ...
                <div class="player-right">
                    ...
                    <span class="flexframe-player-watermark">Powered by <a href="https://fitflexion.com" target="_blank" rel="noopener">FitFlexion</a></span>
                </div>
            </div>
        `;
            ...
            switch(e.code) {
                case 'Space':
                    if (e.target.tagName !== 'INPUT' &&
                        ...
                        !e.target.closest?.('.ff-annotation-card')) {
                        e.preventDefault();
                        this.togglePlayPause();
                    }
                    break;
    ...
    setMixer(mixer, animations) {
        ...
        // Reset playback speed UI to 1x for new model (mixer/actions are fresh)
        this.playbackSpeed = 1;
        if (this.speedText) this.speedText.textContent = '1x';
        if (this.speedMenu) {
