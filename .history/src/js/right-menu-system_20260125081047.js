...
export class RightMenuSystem {
    ...
    createMobileToggleButton(menuContainer) {
        ...
        console.log('[Mobile Toggle] Right button created, width:', window.innerWidth);
    ...
    updateMobileToggleVisibility() {
        if (this.mobileToggleButton) {
            ...
            console.log('[Mobile Toggle] Right visibility check, width:', window.innerWidth, 'isMobile:', isMobile);
            if (isMobile) {
