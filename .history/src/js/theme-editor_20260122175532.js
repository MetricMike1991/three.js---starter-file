...
class ThemeEditor {
            ...
            <div class="te-content">
                ...
                <div class="te-section">
                    <div class="te-section-header" data-section="ui">
                        <span class="te-section-icon">🖥️</span>
                ...
                <div class="te-section">
                    <div class="te-section-header" data-section="material">
                        <span class="te-section-icon">🧬</span>
    ...
    applySettingLive(key, value) {
        ...
        if (key.startsWith('particles') && this.app.particleSystem) {
            ...
            if (key === 'particlesCount' || key === 'particlesEnabled') {
                ...
                this.app.particleSystem.updateMaterial();
            }
        }
    ...
    updateSkinMaterial() {
        ...
        window.model.traverse((child) => {
            if (child.isMesh && child.name && child.name.toLowerCase().includes('skin')) {
                if (child.material) {
                    ...
                    if (child.material.thickness !== undefined) {
                        child.material.thickness = thickness;
                    }
    ...
    async saveTheme() {
        ...
        saveBtn.innerHTML = '<span class="te-btn-icon">⏳</span> Saving...';
        ...
        saveBtn.innerHTML = '<span class="te-btn-icon">💾</span> Save Theme';
    }
