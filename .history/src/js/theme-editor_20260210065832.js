...
class ThemeEditor {
    ...
    applyPrimaryColorToElements(color) {
        ...
        // 5. Update Menu V2 styling (thumbnail labels, accent borders, heading bg use primary color)
        // If menuV2AccentColor is null/USE_PRIMARY_COLOR, it falls back to primaryColor
        this.updateMenuStyling();
        ...
        // 8. Update menuV2AccentColor input display
        ...
        // 9. Update menuV2HeadingBgColor input display
