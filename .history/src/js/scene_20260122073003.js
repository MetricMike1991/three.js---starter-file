...
class SceneManager {
    ...
    updateBackgroundLogo(params) {
        ...
        textureLoader.load(params.url, (texture) => {
            ...
            this.bgLogoSprite.position.set(0, yPos, 3);
            console.log('[SceneManager] Sprite position set to:', 0, yPos, 3);
            
            // Higher render order means render later (on top), negative means render first (behind)
            // But with depthTest, actual Z position matters more
