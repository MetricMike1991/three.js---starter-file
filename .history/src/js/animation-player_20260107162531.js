...
export class AnimationPlayer {
    ...
    initializeScaling() {
        ...
        window.addEventListener('resize', () => {
            this.updatePlayerScale();
            // Set player width to 95% after resize
            if (this.container) {
                this.container.style.width = '95%';
                
                // Console log player width info
                const playerRect = this.container.getBoundingClientRect();
                const windowWidth = window.innerWidth;
                const actualWidthPercentage = (playerRect.width / windowWidth * 100).toFixed(2);
                
                console.log('=== PLAYER WIDTH DEBUG ===');
                console.log(`Window width: ${windowWidth}px`);
                console.log(`Player actual width: ${playerRect.width.toFixed(2)}px`);
                console.log(`Player CSS width: ${this.container.style.width}`);
                console.log(`Player actual width %: ${actualWidthPercentage}%`);
                console.log(`Computed style width: ${getComputedStyle(this.container).width}`);
                console.log('========================');
            }
        });
    }
    ...
    updatePlayerScale() {
        ...
        const playerReferenceWidth = 1200;
