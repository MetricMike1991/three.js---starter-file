        ...
        this.panel.querySelectorAll('input[data-setting]').forEach(input => {
            input.addEventListener('input', (e) => {
                ...
                if (e.target.type === 'checkbox') {
                    ...
                    // Special handling for logo loader toggle
                    if (key === 'useLogoLoader') {
                        const loadingOverlay = document.querySelector('.loading-overlay');
                        const spinnerBox = loadingOverlay?.querySelector('.spinner-box');
                        const logoLoader = spinnerBox?.querySelector('.cool-loader');
                        const spinnerElements = spinnerBox?.querySelectorAll('.spinner-circle, .spinner-dots, .spinner-bars, .spinner-pulse, .spinner-ripple');
                        
                        console.log('[Theme Editor] Logo toggle:', value, {
                            loadingOverlay: !!loadingOverlay,
                            spinnerBox: !!spinnerBox,
                            logoLoader: !!logoLoader,
                            spinnerElements: spinnerElements?.length
                        });
                        
                        if (spinnerBox) {
                            if (value) {
                                // Show logo, hide spinner elements
                                if (logoLoader) {
                            ...
                            console.warn('[Theme Editor] Loading elements not found in DOM');
                        }
                    }
