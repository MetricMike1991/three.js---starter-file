    ...
    restoreExerciseSelection() {
        ...
        if (this.selectedExerciseId && this.menus.exercises && this.menus.exercises.visibleContainer) {
            setTimeout(() => {
                ...
                if (selectedElement) {
                    selectedElement.classList.add('selected');
                    console.log('Restored exercise selection visually:', this.selectedExerciseId);
                } else {
                    console.log('Could not find element to restore selection for:', this.selectedExerciseId);
                }
            }, 150);
        }
    }
