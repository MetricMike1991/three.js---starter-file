...
class SettingsManager {
    ...
    async loadDefaultSettings() {
        try {
            ...
            const response = await fetch(getAssetUrl('data/default-settings.json'));
    ...
    async importSettingsFromClipboard() {
        try {
            ...
            if (window.app && typeof window.app.updateAllGUIControls === 'function') {
                window.app.updateAllGUIControls();
            }
