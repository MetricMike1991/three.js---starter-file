...
export class AnimationPlayer {
    ...
    addCustomStyling() {
        ...
        style.textContent = `
            .animation-player {
                background-color: var(--player-bg-color, #1a1a1a) !important;
                background-opacity: var(--player-bg-opacity, 0.9) !important;
                color: var(--player-text-color, #ffffff) !important;
                width: var(--player-width, 400px) !important;
                height: var(--player-height, 60px) !important;
                border-radius: var(--player-border-radius, 8px) !important;
                font-size: var(--player-font-size, 14px) !important;
                backdrop-filter: blur(10px);
                background: linear-gradient(135deg, 
                    var(--player-bg-color, #1a1a1a)${' '}var(--player-bg-opacity, 0.9), 
                    transparent);
            }
            
            .animation-player button {
                color: var(--player-button-color, #4a9eff) !important;
                font-size: inherit !important;
            }
            
            .animation-player button:hover {
                color: var(--player-button-hover-color, #6bb3ff) !important;
            }
            
            .animation-player .time-display,
            .animation-player .speed-menu {
                color: var(--player-text-color, #ffffff) !important;
                font-size: inherit !important;
            }
            
            .animation-player .timeline-slider {
                accent-color: var(--player-button-color, #4a9eff) !important;
            }
            
            .speed-menu {
                background-color: var(--player-bg-color, #1a1a1a) !important;
                border: 1px solid var(--player-button-color, #4a9eff) !important;
                border-radius: calc(var(--player-border-radius, 8px) / 2) !important;
            }
            
            .speed-option:hover {
                background-color: var(--player-button-color, #4a9eff) !important;
                color: var(--player-bg-color, #1a1a1a) !important;
            }
        `;
