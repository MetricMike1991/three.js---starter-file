    ...
    setupSearchFilters() {
        ...
        muscles.forEach(muscle => {
            ...
            checkbox.addEventListener('change', (e) => {
                ...
                if (e.target.checked) {
                    ...
                    label.style.border = `2px solid ${primaryColor}`;
                    label.style.backgroundColor = `${primaryColor}22`;
                    label.style.boxShadow = `0 0 8px ${primaryColor}66`;
        ...
        if (clearMuscleBtn) {
            clearMuscleBtn.addEventListener('click', () => {
                ...
                muscleFiltersContainer.querySelectorAll('.filter-checkbox-label').forEach(label => label.classList.remove('selected'));
                this.filterDataForMenu();
                this.renderVirtualizedGrid();
            });
        }
        ...
        if (clearEquipmentBtn) {
            clearEquipmentBtn.addEventListener('click', () => {
                ...
                equipmentFiltersContainer.querySelectorAll('.filter-checkbox-label').forEach(label => label.classList.remove('selected'));
                this.filterDataForMenu();
                this.renderVirtualizedGrid();
            });
        }
