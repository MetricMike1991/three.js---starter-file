...
class ThreeJSApp {
    ...
    applyWordPressUISettings() {
        ...
        if (!window.flexframeSettings || !window.flexframeSettings.uiSettings) {
            console.log('[FlexFrame] No WordPress UI settings found, using defaults');
            return;
        }
        
        const uiSettings = window.flexframeSettings.uiSettings;
        console.log('[FlexFrame] Applying WordPress UI settings:', uiSettings);
        
        // Apply player settings
        if (uiSettings.player) {
            // Apply always visible setting
            if (this.animationPlayer) {
                this.animationPlayer.setAlwaysVisible(uiSettings.player.alwaysVisible === true);
            }
