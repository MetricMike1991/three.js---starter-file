...
class ThreeJSApp {
    ...
    async init() {
        ...
        // Apply initial background (may be overridden by WordPress settings below)
        this.sceneManager.updateGradientBackground(this.backgroundParams);
        
        // Apply WordPress scene settings AFTER default background is set
        // This ensures WordPress settings override the defaults
        this.applyWordPressSceneSettings();
