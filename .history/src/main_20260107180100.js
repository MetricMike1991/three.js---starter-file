...
import { ThumbnailMenu } from './js/thumbnail-menu.js';
...
class ThreeJSApp {
    ...
    async init() {
        ...
        // Initialize exercise menu
        this.exerciseMenu = new ExerciseMenu();
        
        // Listen for exercise selection events
        document.addEventListener('exerciseSelected', (e) => {
            console.log('Exercise selected:', e.detail.exercise);
