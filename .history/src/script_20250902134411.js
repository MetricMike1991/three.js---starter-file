// --- Ambient Light ---
// Only declare once, at the top of the script
let ambientLight = new THREE.AmbientLight(0xffffff, 0.2); // Default: white, low intensity
...
// (Removed duplicate ambientLight declaration)
scene.add(ambientLight);
