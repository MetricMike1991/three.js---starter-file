...
class ThreeJSApp {
                                ...
                                if (mat.name) {
                                    ...
                                    // Convert COLOR_1 materials to MeshPhysicalMaterial
                                        ...
                                        if (convertedMaterials.has(mat.name)) {
                                            ...
                                            // Get primary color from WordPress settings or use default red
                                            const primaryColor = window.flexframeSettings?.primaryColor || '#ff0000';
    ...
    applyMaterialPreset1() {
        ...
        const presets = {
            ...
            'COLOR_1': {
                color: window.flexframeSettings?.primaryColor || '#ff0000',
                opacity: 1,
                transparent: false,
                metalness: 0,
                roughness: 0.215,
