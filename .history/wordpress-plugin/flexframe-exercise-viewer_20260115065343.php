...
define('FLEXFRAME_VERSION', '1.2.0');
...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            /* Force plugin styles to override WordPress theme */
            #flexframe-viewer-container,
            #flexframe-viewer-container *,
            #flexframe-viewer-container *::before,
            #flexframe-viewer-container *::after {
                all: initial !important;
                box-sizing: border-box !important;
            }
            
            /* Re-enable display for visible elements */
            #flexframe-viewer-container,
            #flexframe-viewer-container > * {
                all: unset !important;
            ...
            /* Reset critical properties that themes commonly override */
            #flexframe-viewer-container * {
            ...
            /* Prevent pseudo-element interference */
            #flexframe-viewer-container *::before,
            #flexframe-viewer-container *::after {
            ...
            /* Allow flexframe CSS to apply */
            #flexframe-viewer-container .animation-player,
            #flexframe-viewer-container .thumbnail-grid-container,
            #flexframe-viewer-container .thumbnail-grid-container-right,
            #flexframe-viewer-container .right-info-panel,
            #flexframe-viewer-container .webgl,
            #flexframe-viewer-container button,
            #flexframe-viewer-container input,
            #flexframe-viewer-container select {
        ...
        wp_enqueue_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/js/index-PgrexvpV.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
