                ...
                <div class="flexframe-step-section collapsed">
                    ...
                    <div class="flexframe-step-content" style="display: none;">
                        ...
                        <div class="flexframe-custom-panel">
                            ...
                            <input type="hidden" id="flexframe_menu_v2_heading_bg_color" name="flexframe_menu_v2_heading_bg_color" value="<?php echo esc_attr(get_option('flexframe_menu_v2_heading_bg_color', '#1a1a1a')); ?>" />
