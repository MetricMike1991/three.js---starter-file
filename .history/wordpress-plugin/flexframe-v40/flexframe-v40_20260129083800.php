...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        wp_enqueue_style(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-Dw3poQYn.css',
            array(),
            FLEXFRAME_VERSION
        );
        ...
        wp_register_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-Bpy7DSrZ.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
    ...
    <div id="flexframe-viewer-container" style="width: <?php echo esc_attr($atts['width']); ?>; height: <?php echo esc_attr($atts['height']); ?>; position: relative; overflow: hidden; border-radius: 0 !important;">
        ...
        <button id="fullscreen-btn" class="fullscreen-btn" title="Toggle Fullscreen">
            ...
            <svg class="fullscreen-exit-icon" viewBox="0 0 24 24" fill="currentColor" width="24" height="24" style="display: none;">
                ...
                <path d="M9 3v6H3v-2h4V3h2zm6 0h2v4h4v2h-6V3zM3 15h6v6H7v-4H3v-2zm12 6v-6h6v2h-4v4h-2z"/>
            </svg>
        </button>
