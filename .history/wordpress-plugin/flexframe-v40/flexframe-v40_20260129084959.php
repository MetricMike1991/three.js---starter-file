...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        wp_enqueue_style(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-CYLWQhck.css',
            array(),
            FLEXFRAME_VERSION
        );
        ...
        wp_register_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-CdhFbOHb.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
...
function flexframe_viewer_shortcode($atts) {
    ...
    <div id="flexframe-viewer-container" style="width: <?php echo esc_attr($atts['width']); ?>; height: <?php echo esc_attr($atts['height']); ?>; position: relative; overflow: hidden; border-radius: 0 !important;">
        ...
        <button id="fullscreen-btn" class="fullscreen-btn" title="Toggle Fullscreen">
            <svg class="fullscreen-enter-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="20" height="20">
                <!-- Expand icon - arrows pointing to corners -->
                <path d="M10 19H5V14M14 5H19V10"/>
            </svg>
            <svg class="fullscreen-exit-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="20" height="20" style="display: none;">
                <!-- Contract icon - arrows pointing inward -->
                <path d="M5 14h5v5M19 10h-5V5"/>
            </svg>
        </button>
