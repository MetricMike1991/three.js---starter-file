...
define('FLEXFRAME_VERSION', '1.26.0');
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (leftHintTab && leftMenuContainer) {
                    ...
                    leftHintTab.addEventListener('click', function(e) {
                        ...
                        console.log('[FlexFrame] Left menu toggled:', leftMenuContainer.classList.contains('menu-visible'));
                    });
                }
                ...
                if (rightHintTab && rightMenuContainer) {
                    ...
                    rightHintTab.addEventListener('click', function(e) {
                        ...
                        console.log('[FlexFrame] Right menu toggled:', rightMenuContainer.classList.contains('menu-visible'));
                    });
                }
            });
        ";
