...
define('FLEXFRAME_VERSION', '1.41.440');
...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        wp_register_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-Chr-Fs78.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
...
function flexframe_viewer_shortcode($atts) {
    ...
    <div id="flexframe-viewer-container" style="width: <?php echo esc_attr($atts['width']); ?>; height: <?php echo esc_attr($atts['height']); ?>; position: relative; overflow: hidden; border-radius: 0 !important;">
        ...
        $bg_logo_pos_y_css = 100 - $bg_logo_pos_y;
        $bg_logo_half = round($bg_logo_size / 2);
        
        // Use left:0;right:0;margin:auto centering for X=50 (no transform needed)
        // Use calc() for non-centered positions
        if ($bg_logo_pos_x == 50) {
            $h_pos_style = "left:0 !important;right:0 !important;margin-left:auto !important;margin-right:auto !important;";
        } else {
            $h_pos_style = "left:calc(" . esc_attr($bg_logo_pos_x) . "% - " . esc_attr($bg_logo_half) . "px) !important;right:auto !important;margin-left:0 !important;margin-right:0 !important;";
        }
        
        if ($bg_logo_enabled && !empty($logo_url)) :
        ?>
        <!-- Logo Watermark v<?php echo FLEXFRAME_VERSION; ?> build-440 -->
        <div class="flexframe-bg-watermark-wrap" style="position:absolute !important;top:0 !important;left:0 !important;right:0 !important;bottom:0 !important;width:100% !important;height:100% !important;margin:0 !important;padding:0 !important;pointer-events:none !important;z-index:1 !important;overflow:hidden !important;box-sizing:border-box !important;">
            <div class="flexframe-bg-watermark" style="position:absolute !important;top:<?php echo esc_attr($bg_logo_pos_y_css); ?>% !important;<?php echo $h_pos_style; ?>width:<?php echo esc_attr($bg_logo_size); ?>px;max-width:<?php echo esc_attr($bg_logo_size); ?>px;height:auto !important;opacity:<?php echo esc_attr($bg_logo_opacity); ?> !important;pointer-events:none !important;margin-top:0 !important;margin-bottom:0 !important;padding:0 !important;float:none !important;display:block !important;bottom:auto !important;transform:none !important;-webkit-transform:none !important;">
                <img src="<?php echo esc_url($logo_url); ?>" alt="" style="width:100% !important;height:auto !important;max-width:100% !important;display:block !important;pointer-events:none !important;margin:0 !important;padding:0 !important;float:none !important;position:static !important;transform:none !important;-webkit-transform:none !important;" draggable="false" />
            </div>
        </div>
        <?php endif; ?>
    </div>
