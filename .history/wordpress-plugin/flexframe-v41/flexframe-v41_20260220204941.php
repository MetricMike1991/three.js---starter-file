...
function flexframe_viewer_shortcode($atts) {
    ...
    <div id="flexframe-viewer-container" style="width: <?php echo esc_attr($atts['width']); ?>; height: <?php echo esc_attr($atts['height']); ?>; position: relative; overflow: hidden; border-radius: 0 !important;">
        ...
        <?php
        // Calculate half-width for centering without transform (more theme-compatible)
        $bg_logo_half = round($bg_logo_size / 2);
        ?>
        <?php if ($bg_logo_enabled && !empty($logo_url)) : ?>
        <!-- Logo Watermark v<?php echo FLEXFRAME_VERSION; ?> -->
        <div class="flexframe-bg-watermark-wrap" style="position:absolute !important;top:0 !important;left:0 !important;right:0 !important;bottom:0 !important;width:100% !important;height:100% !important;margin:0 !important;padding:0 !important;pointer-events:none !important;z-index:1 !important;overflow:hidden !important;box-sizing:border-box !important;">
            <div class="flexframe-bg-watermark" style="position:absolute !important;top:<?php echo esc_attr($bg_logo_pos_y_css); ?>% !important;left:calc(<?php echo esc_attr($bg_logo_pos_x); ?>% - <?php echo esc_attr($bg_logo_half); ?>px) !important;width:<?php echo esc_attr($bg_logo_size); ?>px !important;max-width:<?php echo esc_attr($bg_logo_size); ?>px !important;height:auto !important;opacity:<?php echo esc_attr($bg_logo_opacity); ?> !important;pointer-events:none !important;margin:0 !important;padding:0 !important;float:none !important;display:block !important;right:auto !important;bottom:auto !important;transform:none !important;-webkit-transform:none !important;">
