...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        wp_enqueue_style(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-HbJ-27w7.css',
            array(),
            FLEXFRAME_VERSION
        );
        ...
        wp_register_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-VsYoaGns.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
        ...
        $settings_data = array(
            ...
            'testModelUrl' => (get_option('flexframe_test_model_enabled', false) ? esc_url(get_option('flexframe_test_model_url', '')) : ''),
