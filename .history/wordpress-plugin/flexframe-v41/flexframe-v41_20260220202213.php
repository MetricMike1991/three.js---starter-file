...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            /* Ensure viewer container is proper positioning context for watermark */
            #flexframe-viewer-container {
                position: relative !important;
                width: 100% !important;
                overflow: hidden !important;
...
function flexframe_viewer_shortcode($atts) {
    ...
    ?>
    <div id="flexframe-viewer-container" style="width: <?php echo esc_attr($atts['width']); ?>; height: <?php echo esc_attr($atts['height']); ?>; position: relative !important; overflow: hidden !important; border-radius: 0 !important;">
        <!-- Model Loader -->
        ...
        <div class="flexframe-bg-watermark" style="
            position: absolute !important;
            top: <?php echo esc_attr($bg_logo_pos_y_css); ?>% !important;
            left: <?php echo esc_attr($bg_logo_pos_x); ?>% !important;
            right: auto !important;
            bottom: auto !important;
            transform: translate(-50%, -50%) !important;
            -webkit-transform: translate(-50%, -50%) !important;
            width: <?php echo esc_attr($bg_logo_size); ?>px !important;
            height: auto !important;
            opacity: <?php echo esc_attr($bg_logo_opacity); ?> !important;
            pointer-events: none !important;
            z-index: 1 !important;
            user-select: none !important;
