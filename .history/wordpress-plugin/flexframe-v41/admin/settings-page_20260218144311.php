...
function flexframe_settings_page() {
                            ...
                            <table class="wp-list-table widefat fixed striped" id="flexframe-email-captures-table" style="margin-bottom: 12px;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 22%;">Workout</th>
                                        <th style="width: 22%;">Date</th>
                                        <th style="width: 14%;">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr><td colspan="5" style="text-align: center; padding: 20px; color: #666;">Click "Refresh" to load email captures.</td></tr>
                                </tbody>
                            </table>
    ...
    jQuery(document).ready(function($) {
        ...
        function loadEmailCaptures(page) {
            ...
            $tbody.html('<tr><td colspan="5" style="text-align:center;padding:20px;color:#666;">Loading...</td></tr>');
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (!response.success) {
                        $tbody.html('<tr><td colspan="5" style="text-align:center;color:#d63638;">Error loading data.</td></tr>');
                        return;
                    }
                    var d = response.data;
                    ...
                    if (d.rows.length === 0) {
                        $tbody.html('<tr><td colspan="5" style="text-align:center;padding:20px;color:#666;">No email captures yet.</td></tr>');
                        $pagination.empty();
                        return;
                    }
