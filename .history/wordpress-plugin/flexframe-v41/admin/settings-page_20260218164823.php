...
function flexframe_settings_page() {
                            ...
                            <div class="custom-panel-content" id="workout-saved-content">
                                ...
                                <div id="flexframe-saved-workouts-container">
                                    <table class="wp-list-table widefat fixed striped" id="flexframe-saved-workouts-table" style="margin-bottom: 12px;">
                                        ...
                                        <tbody>
                                            <tr><td colspan="9" style="text-align: center; padding: 20px; color: #666;">Click "Refresh" to load saved workouts.</td></tr>
                                        </tbody>
                                    </table>
    ...
    jQuery(document).ready(function($) {
        ...
        function loadSavedWorkouts(page) {
            ...
            $wkTbody.html('<tr><td colspan="9" style="text-align:center;padding:20px;color:#666;">Loading...</td></tr>');
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (!response.success) {
                        $wkTbody.html('<tr><td colspan="9" style="text-align:center;color:#d63638;">Error loading data.</td></tr>');
                        return;
                    }
                    var d = response.data;
                    ...
                    if (d.rows.length === 0) {
                        $wkTbody.html('<tr><td colspan="9" style="text-align:center;padding:20px;color:#666;">No saved workouts yet.</td></tr>');
                        $wkPagination.empty();
                        return;
                    }
