...
function flexframe_settings_page() {
    ...
    jQuery(document).ready(function($) {
        ...
        $(document).on('click', '.embed-code-btn', function() {
            ...
            modalHtml += '      <div class="embed-toggle-row">';
            modalHtml += '        <div class="embed-toggle-label"><span class="label-title">Show UI Controls</span><span class="label-desc">Show playback controls and exercise menu</span></div>';
            modalHtml += '        <label class="embed-toggle-switch"><input type="checkbox" id="embed-show-ui" ' + (embedDefaults.showUI ? 'checked' : '') + ' /><span class="embed-toggle-slider"></span></label>';
            modalHtml += '      </div>';
        ...
        $(document).on('input change', '#embed-width, #embed-height, #embed-border-radius, #embed-border-style, #embed-responsive, #embed-autoplay, #embed-show-ui, #embed-fullscreen', function() {
            updateEmbedCode();
        });
        ...
        function updateEmbedCode() {
            ...
            var showUI = $('#embed-show-ui').is(':checked');
            ...
            if (responsive) {
                ...
                embedCode += '<div style="position:relative;width:100%;max-width:' + width + 'px;padding-bottom:' + aspectRatio + '%;height:0;overflow:hidden;">\n';
