...
function flexframe_settings_page() {
    ...
    jQuery(document).ready(function($) {
        ...
        $(document).on('input change', '#embed-width, #embed-height, #embed-border-radius, #embed-border-style, #embed-responsive, #embed-autoplay, #embed-show-player, #embed-fullscreen, #embed-transparent-bg', function() {
            updateEmbedCode();
        });
