        ...
        (function() {
            ...
            $('#flexframe_upload_logo_button').on('click', function(e) {
                ...
                if (typeof wp === 'undefined' || typeof wp.media === 'undefined') {
                    alert('<?php _e('Media uploader is not available. Please reload the page and try again.', 'flexframe-viewer'); ?>');
                    return;
                }
                
                // Create a new media uploader
                logoMediaUploader = wp.media({
                    title: '<?php _e('Select Logo Image', 'flexframe-viewer'); ?>',
                    button: {
                        text: '<?php _e('Use this image', 'flexframe-viewer'); ?>'
                    },
                    library: {
                        type: 'image'
                    },
                ...
                logoMediaUploader.on('select', function() {
                    ...
                    $('#flexframe_logo_preview').html(
                        '<img src="' + attachment.url + '" alt="Logo Preview" id="flexframe_logo_preview_img" style="max-width: 200px; max-height: 200px; margin-top: 10px;">'
                    ).show();
                    
                    // Show remove button
                    $('#flexframe_remove_logo_button').show();
                    
                    // Update logo preview with current settings
