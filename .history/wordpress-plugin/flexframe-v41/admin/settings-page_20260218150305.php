...
function flexframe_settings_page() {
        ...
        <div class="flexframe-settings-container">
            ...
            <form method="post" action="options.php" id="flexframe-settings-form">
                ...
                <div class="flexframe-step-section collapsed">
                    ...
                    <div class="flexframe-step-content" style="display: none;">
                        ...
                        <div class="flexframe-getting-started">
                            <div class="getting-started-header">
                                ...
                                <h3><?php _e('Workout Builder', 'flexframe-viewer'); ?></h3>
                            </div>
                            <p class="getting-started-desc">
                            ...
                            <p class="description" style="margin-top: 8px;">
                                <?php _e('Click to automatically create a full-screen page with the Workout Builder shortcode. No sidebars, headers, or footers.', 'flexframe-viewer'); ?>
                            </p>
                        </div>
                    ...
                    <!-- Privacy Policy -->
                    <div class="flexframe-setting-group" style="margin-top: 30px;">
                        <h3 style="margin: 0 0 8px;">🔒 Privacy Policy Page</h3>
                    ...
                    <!-- Email Captures -->
                    <div class="flexframe-setting-group" style="margin-top: 30px;">
                        <div class="flexframe-setting-header" style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px;">
                            <div>
                                <h3 style="margin: 0 0 4px;">📧 Email Captures</h3>
                        ...
                        <div id="flexframe-email-captures-container">
                            <table class="wp-list-table widefat fixed striped" id="flexframe-email-captures-table" style="margin-bottom: 12px;">
                                ...
                                <tbody>
                                    <tr><td colspan="6" style="text-align: center; padding: 20px; color: #666;">Click "Refresh" to load email captures.</td></tr>
                                </tbody>
                            </table>
    ...
    jQuery(document).ready(function($) {
        ...
        function loadEmailCaptures(page) {
            ...
            $tbody.html('<tr><td colspan="6" style="text-align:center;padding:20px;color:#666;">Loading...</td></tr>');
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (!response.success) {
                        $tbody.html('<tr><td colspan="6" style="text-align:center;color:#d63638;">Error loading data.</td></tr>');
                        return;
                    }
                    var d = response.data;
                    ...
                    if (d.rows.length === 0) {
                        $tbody.html('<tr><td colspan="6" style="text-align:center;padding:20px;color:#666;">No email captures yet.</td></tr>');
                        $pagination.empty();
                        return;
                    }
