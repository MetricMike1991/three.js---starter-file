...
function flexframe_viewer_shortcode($atts) {
    ...
    <div id="flexframe-viewer-container" style="width: <?php echo esc_attr($atts['width']); ?>; height: <?php echo esc_attr($atts['height']); ?>; position: relative; overflow: hidden; border-radius: 0 !important;">
        ...
        ?>
        <!-- Logo Watermark Overlay - full-coverage flex approach -->
        <div class="flexframe-bg-watermark-wrap" style="position:absolute !important;top:0 !important;left:0 !important;right:0 !important;bottom:0 !important;width:100% !important;height:100% !important;margin:0 !important;padding:0 !important;display:flex !important;pointer-events:none !important;z-index:1 !important;overflow:hidden !important;box-sizing:border-box !important;">
            <div class="flexframe-bg-watermark" style="position:absolute !important;top:<?php echo esc_attr($bg_logo_pos_y_css); ?>% !important;left:<?php echo esc_attr($bg_logo_pos_x); ?>% !important;transform:translate(-50%,-50%) !important;-webkit-transform:translate(-50%,-50%) !important;width:<?php echo esc_attr($bg_logo_size); ?>px !important;max-width:<?php echo esc_attr($bg_logo_size); ?>px !important;height:auto !important;opacity:<?php echo esc_attr($bg_logo_opacity); ?> !important;pointer-events:none !important;margin:0 !important;padding:0 !important;float:none !important;display:block !important;right:auto !important;bottom:auto !important;">
