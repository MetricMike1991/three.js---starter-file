...
define('FLEXFRAME_VERSION', '1.41.476');
...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        wp_register_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-B368pA0k.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
...
function flexframe_viewer_shortcode($atts) {
    ...
    <div id="flexframe-viewer-container" style="width: <?php echo esc_attr($atts['width']); ?>; height: <?php echo esc_attr($atts['height']); ?>; position: relative; overflow: hidden; border-radius: 0 !important;">
        ...
        <!-- Fullscreen Button -->
        <button id="fullscreen-btn" class="fullscreen-btn" title="Toggle Fullscreen"<?php
            // In embed mode with hideFullscreen, hide directly via inline style (belt-and-suspenders)
            if (isset($_GET['embed']) && $_GET['embed'] === '1' && isset($_GET['hideFullscreen']) && $_GET['hideFullscreen'] === '1') {
...
function flexframe_embed_mode_redirect() {
    ...
    $js_url = FLEXFRAME_PLUGIN_URL . 'assets/assets/index-B368pA0k.js';
