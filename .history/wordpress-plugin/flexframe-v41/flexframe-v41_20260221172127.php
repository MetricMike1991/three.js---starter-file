...
define('FLEXFRAME_VERSION', '1.41.466');
...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        wp_enqueue_style(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-Bist1BIB.css',
            array(),
            FLEXFRAME_VERSION
        );
        ...
        wp_register_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-DpBc9pOx.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
...
function flexframe_viewer_shortcode($atts) {
    ...
    <div id="flexframe-viewer-container" style="width: <?php echo esc_attr($atts['width']); ?>; height: <?php echo esc_attr($atts['height']); ?>; position: relative; overflow: hidden; border-radius: 0 !important;">
        ...
        (function(){
            ...
            wm.appendChild(img);
            wrap.appendChild(wm);
            // Append inside the viewer container so it shares the same stacking context as UI
            ...
            var ws = wrap.style;
            ws.cssText = 'position:absolute;top:0;left:0;width:100%;height:100%;margin:0;padding:0;pointer-events:none;z-index:1;overflow:hidden;box-sizing:border-box;';
