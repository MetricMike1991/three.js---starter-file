...
function flexframe_dashboard_shortcode($atts) {
    ...
    // Redirect back to the dashboard page after login
    $dashboard_redirect = get_option('flexframe_dashboard_page_url', home_url());
    $login_url     = esc_url(wp_login_url($dashboard_redirect));
