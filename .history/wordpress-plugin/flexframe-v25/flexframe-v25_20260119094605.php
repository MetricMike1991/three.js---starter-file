...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $ui_css .= '
            ...
            /* Menu button hover states - controlled by accent color */
            .thumbnail-menu-toggle:hover,
            .thumbnail-menu-toggle.active,
            .thumbnail-menu-toggle:focus {
            ...
            /* Search button/icon - accent color */
            .search-action-btn,
            .search-btn,
            #searchActionBtn {
                background-color: ' . $menu_accent_color . ' !important;
            ...
            #searchInput:focus {
                border-color: ' . $menu_accent_color . ' !important;
                outline-color: ' . $menu_accent_color . ' !important;
            }
            /* Section headers - POPULAR EXERCISES, MUSCLE GROUPS, etc */
            .section-header,
            .menu-section-header,
            .category-header,
            .group-header,
            ...
            /* Exercise list item icons/bullets */
            .exercise-item::before,
            .menu-item::before,
            .exercise-list-item::before {
                color: ' . $menu_accent_color . ' !important;
            }
            /* Exercise item icons (dumbbell icons etc) */
            .exercise-icon,
            .item-icon,
            .exercise-item svg,
            .menu-item svg {
            ...
            /* Any remaining blue links/elements in menus */
            ...
            .thumbnail-dropdown [style*="color: rgb(74, 158, 255)"],
            .thumbnail-dropdown [style*="color:#4a9eff"] {
                color: ' . $menu_accent_color . ' !important;
            }
        ';
