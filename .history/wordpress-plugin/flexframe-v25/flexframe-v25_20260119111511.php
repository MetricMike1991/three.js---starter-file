    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            #flexframe-viewer-container .thumbnail-grid-container-right {
                position: fixed !important;
                right: -320px !important; /* Fully hidden off-screen */
                z-index: 9999 !important;
                pointer-events: auto !important;
                transition: right 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94) !important;
            }
            /* Only slide in when menu-visible class is added via button */
        ...
        $ui_css .= '
            ...
            #flexframe-viewer-container #leftMenuToggle,
            .menu-hint-tab,
            #leftMenuToggle {
                position: fixed !important;
                top: 50% !important;
            ...
            #flexframe-viewer-container .menu-hint-tab.menu-open,
            #flexframe-viewer-container #leftMenuToggle.menu-open,
            .menu-hint-tab.menu-open,
            #leftMenuToggle.menu-open {
            ...
            #flexframe-viewer-container #leftMenuToggle svg,
            .menu-hint-tab svg,
            #leftMenuToggle svg {
            ...
            #flexframe-viewer-container #leftMenuToggle:hover,
            .menu-hint-tab:hover,
            ...
            #flexframe-viewer-container #leftMenuToggle:hover svg,
            .menu-hint-tab:hover svg,
            #leftMenuToggle:hover svg {
            ...
            #flexframe-viewer-container #rightMenuToggle,
            .menu-hint-tab-right,
            #rightMenuToggle {
                position: fixed !important;
                top: 50% !important;
            ...
            /* Move button when menu is open */
            #flexframe-viewer-container .menu-hint-tab-right.menu-open,
            #flexframe-viewer-container #rightMenuToggle.menu-open,
            .menu-hint-tab-right.menu-open,
            #rightMenuToggle.menu-open {
            ...
            #flexframe-viewer-container #rightMenuToggle svg,
            ...
            #flexframe-viewer-container #rightMenuToggle:hover,
            ...
            #flexframe-viewer-container #rightMenuToggle:hover svg,
            .menu-hint-tab-right:hover svg,
            #rightMenuToggle:hover svg {
                fill: #ffffff !important;
            }
        ...
        // Add menu toggle button functionality
        $toggle_js = "
            document.addEventListener('DOMContentLoaded', function() {
                // Left menu toggle button
                var leftHintTab = document.getElementById('leftMenuToggle');
                ...
                if (leftHintTab && leftMenuContainer) {
                    ...
                    leftHintTab.addEventListener('click', function(e) {
                        e.stopPropagation();
                        var isVisible = leftMenuContainer.classList.toggle('menu-visible');
                        // Also toggle class on the button for styling
                        leftHintTab.classList.toggle('menu-open', isVisible);
                    });
                }
                
                // Right menu toggle button
                var rightHintTab = document.getElementById('rightMenuToggle');
                ...
                if (rightHintTab && rightMenuContainer) {
                    ...
                    rightHintTab.addEventListener('click', function(e) {
                        e.stopPropagation();
                        var isVisible = rightMenuContainer.classList.toggle('menu-visible');
                        // Also toggle class on the button for styling
                        rightHintTab.classList.toggle('menu-open', isVisible);
                    });
                }
            });
        ";
...
function flexframe_viewer_shortcode($atts) {
    ...
    <div id="flexframe-viewer-container" style="width: <?php echo esc_attr($atts['width']); ?>; height: <?php echo esc_attr($atts['height']); ?>; position: relative;">
        ...
        <!-- Left Menu Toggle Button (Fixed Position) -->
        <div class="menu-hint-tab" id="leftMenuToggle">
        ...
        <!-- Right Menu Toggle Button (Fixed Position) -->
        <div class="menu-hint-tab-right" id="rightMenuToggle">
            <!-- Information Icon -->
            <svg viewBox="0 0 24 24" fill="currentColor">
