...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $ui_css .= '
            ...
            /* Right menu toggle buttons - text color */
            #flexframe-viewer-container .thumbnail-menu-toggle-right,
            #flexframe-viewer-container .thumbnail-menu-toggle-right *,
            #flexframe-viewer-container .thumbnail-menu-toggle-right span,
            .thumbnail-grid-container-right .thumbnail-menu-toggle-right,
            .thumbnail-grid-container-right .thumbnail-menu-toggle-right *,
            .thumbnail-grid-container-right .thumbnail-menu-toggle-right span,
            .thumbnail-menu-toggle-right,
            .thumbnail-menu-toggle-right *,
            .thumbnail-menu-toggle-right span {
                background-color: rgba(' . $menu_bg_rgb[0] . ', ' . $menu_bg_rgb[1] . ', ' . $menu_bg_rgb[2] . ', ' . $menu_bg_opacity . ') !important;
                color: ' . $menu_text_color . ' !important;
            }
            /* Right menu toggle button icons */
            #flexframe-viewer-container .thumbnail-menu-toggle-right svg,
            .thumbnail-grid-container-right .thumbnail-menu-toggle-right svg,
            .thumbnail-menu-toggle-right svg {
                fill: ' . $menu_text_color . ' !important;
            }
            #flexframe-viewer-container .thumbnail-menu-toggle-right:hover,
            #flexframe-viewer-container .thumbnail-menu-toggle-right.active,
            .thumbnail-menu-toggle-right:hover,
            .thumbnail-menu-toggle-right.active {
                background-color: ' . $menu_accent_color . ' !important;
            }
