...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $ui_css .= '
            ...
            /* Move button to the left when menu is visible */
            #flexframe-viewer-container .thumbnail-grid-container-right.menu-visible ~ .menu-hint-tab-right,
            #flexframe-viewer-container .thumbnail-grid-container-right.menu-visible .menu-hint-tab-right,
            .thumbnail-grid-container-right.menu-visible .menu-hint-tab-right {
