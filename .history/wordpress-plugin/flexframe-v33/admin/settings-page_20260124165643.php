...
function flexframe_settings_page() {
    ...
    jQuery(document).ready(function($) {
        ...
        // Get current settings - wrapper with logging
        function getCurrentSettings() {
            var settings = getCurrentSettingsRaw();
            console.log('[Theme Save] Collecting current settings:', {
                primary_color: settings.primary_color,
                primary_color_mode: settings.primary_color_mode
            });
            return settings;
        }
        
        // Get current settings - raw data collection
        function getCurrentSettingsRaw() {
            // Collect equipment material settings
            var equipmentMaterials = {};
            var materialKeys = ['barbell', 'bumper', 'cable', 'chrome', 'color1', 'metal', 'pad', 'plastic', 'rubber'];
