...
function flexframe_save_custom_preset() {
    ...
    $sanitized_data = array(
        ...
        'settings' => array(
            ...
            // Mobile UI Settings
            'mobile_font_size_title' => intval($preset_data['mobile_font_size_title'] ?? 10),
            'mobile_font_size_text' => intval($preset_data['mobile_font_size_text'] ?? 9),
            'mobile_info_bg_color' => sanitize_hex_color($preset_data['mobile_info_bg_color'] ?? '#0516ff'),
            'mobile_info_bg_opacity' => floatval($preset_data['mobile_info_bg_opacity'] ?? 0.13),
            'mobile_info_blur' => intval($preset_data['mobile_info_blur'] ?? 10),
        )
    );
