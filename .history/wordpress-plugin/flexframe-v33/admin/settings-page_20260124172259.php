...
function flexframe_settings_page() {
    ...
    jQuery(document).ready(function($) {
        ...
        $('#apply-preset-theme').on('click', function() {
            ...
            var primaryColorValue = $('#flexframe_primary_color').val();
            var primaryColorMode = $('input[name="flexframe_primary_color_mode"]').val();
            console.log('[Theme Save] About to submit form with primary_color:', primaryColorValue, 'mode:', primaryColorMode);
