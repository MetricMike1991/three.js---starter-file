...
function flexframe_settings_page() {
    ...
    jQuery(document).ready(function($) {
        ...
        function applyBuiltInPreset(presetId) {
            ...
            console.log('[Theme Load] Converted settings to apply:', settingsToApply);
        ...
        $('#apply-preset-theme').on('click', function() {
            ...
            var $btn = $(this);
            $btn.prop('disabled', true).html('<span class="dashicons dashicons-update spin" style="margin-top: 4px;"></span> <?php _e('Loading...', 'flexframe-viewer'); ?>');
            
            // Apply the preset settings to form fields
            if (isCustomTheme) {
                // Load custom preset via AJAX
                loadCustomPreset(presetId);
                // Show success after AJAX completes (longer delay)
                setTimeout(function() {
                    ...
                    showPresetMessage('<?php _e('Theme loaded! Review the settings below, then click "Save Settings" to apply.', 'flexframe-viewer'); ?>', 'success');
                    // Reset button text after 2 seconds
                    setTimeout(function() {
                        $btn.html('<span class="dashicons dashicons-admin-appearance" style="margin-top: 4px;"></span> <?php _e('Apply Theme', 'flexframe-viewer'); ?>');
                    }, 2000);
                }, 800);
            } else {
