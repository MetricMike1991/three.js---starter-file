...
define('FLEXFRAME_VERSION', '1.33.3');
define('FLEXFRAME_PLUGIN_DIR', plugin_dir_path(__FILE__));
define('FLEXFRAME_PLUGIN_URL', plugin_dir_url(__FILE__));

// Log plugin initialization
flexframe_log('Plugin loaded', array('version' => '1.33.3', 'plugin_url' => plugin_dir_url(__FILE__)));
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            @media screen and (max-width: 768px) {
                /* Menus hidden off-screen by default on mobile - toggle via JS button click */
                #flexframe-viewer-container .thumbnail-grid-container {
                ...
                /* MOBILE: Hide hint tabs - using standalone toggle buttons instead */
                .menu-hint-tab,
                .menu-hint-tab-right {
                    display: none !important;
                }
            ...
            @media screen and (max-width: 480px) {
                ...
                /* Smaller hint tabs on small screens */
                .menu-hint-tab,
                .menu-hint-tab-right {
        ...
        $ui_css .= '
            ...
            /* ===== MOBILE: HIDE HINT TABS (must come after hint-tab styles to override) ===== */
            @media screen and (max-width: 768px) {
                #flexframe-viewer-container .menu-hint-tab,
                .thumbnail-grid-container .menu-hint-tab,
                .menu-hint-tab,
