    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            @media screen and (max-width: 768px) {
                ...
                /* Hint tabs visible and larger on mobile */
                .menu-hint-tab {
                    display: block !important;
                    width: 25px !important;
                    height: 70px !important;
                    right: -25px !important;
                    background: linear-gradient(90deg, rgba(<?php echo $primary_rgb; ?>, 0.4) 0%, rgba(<?php echo $primary_rgb; ?>, 0.7) 50%, rgba(<?php echo $primary_rgb; ?>, 0.9) 100%) !important;
                    opacity: 1 !important;
                ...
                .menu-hint-tab-right {
                    ...
                    height: 70px !important;
                    left: -25px !important;
                    background: linear-gradient(270deg, rgba(<?php echo $primary_rgb; ?>, 0.4) 0%, rgba(<?php echo $primary_rgb; ?>, 0.7) 50%, rgba(<?php echo $primary_rgb; ?>, 0.9) 100%) !important;
                    opacity: 1 !important;
                    z-index: 2001 !important;
                }
