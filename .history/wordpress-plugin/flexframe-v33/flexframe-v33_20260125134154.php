    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            @media screen and (max-width: 768px) {
                ...
                /* Left Hint Tab - Circular button (inactive state) */
                .menu-hint-tab {
                    display: block !important;
                    ...
                    border: 2px solid rgba(<?php echo $primary_rgb; ?>, 0.6) !important;
                ...
                /* Left Hint Tab - Active state (full color with white icon) */
                #flexframe-viewer-container .thumbnail-grid-container.mobile-open .menu-hint-tab {
                    ...
                    border-color: rgba(<?php echo $primary_rgb; ?>, 1) !important;
                    opacity: 1 !important;
                }
                ...
                /* Right Hint Tab - Circular button (inactive state) */
                .menu-hint-tab-right {
                    display: block !important;
                    width: 40px !important;
                    height: 40px !important;
                ...
                /* Right Hint Tab - Active state (full color with white icon) */
