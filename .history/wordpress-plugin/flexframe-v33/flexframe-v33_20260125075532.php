    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            @media screen and (max-width: 768px) {
                /* Menus hidden off-screen by default on mobile - toggle via hint tab click */
                #flexframe-viewer-container .thumbnail-grid-container {
                ...
                /* MOBILE: Show hint tabs as clickable toggle buttons */
                .menu-hint-tab,
                .menu-hint-tab-right {
                    display: flex !important;
                ...
                .menu-hint-tab:active,
                .menu-hint-tab-right:active {
                    background: rgba(74, 158, 255, 0.3) !important;
