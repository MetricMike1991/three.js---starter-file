...
flexframe_log('Plugin loaded', array('version' => '1.33.5', 'plugin_url' => plugin_dir_url(__FILE__)));
...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            /* HOVER SUPPORT for desktop - show menus on hover */
            ...
            /* MOBILE RESPONSIVE - menus always visible on small screens */
            @media screen and (max-width: 768px) {
                ...
                /* Animation player always visible on mobile */
...
function flexframe_viewer_shortcode($atts) {
    ...
    <div id="flexframe-viewer-container" style="width: <?php echo esc_attr($atts['width']); ?>; height: <?php echo esc_attr($atts['height']); ?>; position: relative; overflow: hidden;">
        ...
        <!-- Animation Player is created by JavaScript for proper styling -->
    </div>
    <?php
    return ob_get_clean();
}
