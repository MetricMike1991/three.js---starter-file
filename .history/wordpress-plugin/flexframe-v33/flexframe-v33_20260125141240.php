    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            @media screen and (max-width: 768px) {
                /* Left Menu - Slide in/out on mobile */
                #flexframe-viewer-container .thumbnail-grid-container {
                    width: 130px !important;
                    left: -85px !important; /* Position so hint tab stays visible */
                    top: 100px !important;
                    gap: 4px !important;
                    transition: left 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94) !important;
                    pointer-events: none !important; /* Disable hover - only hint tab clickable */
                }
                /* Completely disable hover on mobile */
                #flexframe-viewer-container .thumbnail-grid-container:hover {
                    left: -85px !important;
                }
                /* Show menu when mobile-open */
                #flexframe-viewer-container .thumbnail-grid-container.mobile-open,
                #flexframe-viewer-container .thumbnail-grid-container.mobile-open:hover {
                    left: 8px !important;
                    pointer-events: auto !important;
                }
                
                /* Right Menu - Slide in/out on mobile */
                #flexframe-viewer-container .thumbnail-grid-container-right {
                    width: 130px !important;
                    right: -85px !important; /* Position so hint tab stays visible */
                    top: 100px !important;
                    gap: 4px !important;
                    transition: right 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94) !important;
                    pointer-events: none !important; /* Disable hover - only hint tab clickable */
                ...
                /* Show menu when mobile-open */
                #flexframe-viewer-container .thumbnail-grid-container-right.mobile-open,
                #flexframe-viewer-container .thumbnail-grid-container-right.mobile-open:hover {
                    right: 8px !important;
                    pointer-events: auto !important;
                }
                
                /* Left Hint Tab - Circular button (default: full color when menu hidden) */
                .menu-hint-tab {
                    display: block !important;
                    ...
                    background: rgba(<?php echo $primary_rgb; ?>, 1) !important;
                    border: 2px solid rgba(<?php echo $primary_rgb; ?>, 1) !important;
                    opacity: 1 !important;
                ...
                /* Left Hint Tab - Active state (semi-transparent when menu is out) */
                #flexframe-viewer-container .thumbnail-grid-container.mobile-open .menu-hint-tab {
                    background: rgba(255, 255, 255, 0.2) !important;
                    border-color: rgba(<?php echo $primary_rgb; ?>, 0.6) !important;
                    opacity: 0.5 !important;
                }
                #flexframe-viewer-container .thumbnail-grid-container.mobile-open .menu-hint-tab::before {
                    content: "◀" !important;
                    color: #000 !important;
                    transform: translate(50%, -50%) !important;
                }
                
                /* Right Hint Tab - Circular button (default: full color when menu hidden) */
                .menu-hint-tab-right {
                    display: block !important;
                    width: 40px !important;
                    height: 40px !important;
                ...
                /* Right Hint Tab - Active state (semi-transparent when menu is out) */
                #flexframe-viewer-container .thumbnail-grid-container-right.mobile-open .menu-hint-tab-right {
                    background: rgba(255, 255, 255, 0.2) !important;
                    border-color: rgba(<?php echo $primary_rgb; ?>, 0.6) !important;
                    opacity: 0.5 !important;
                }
                #flexframe-viewer-container .thumbnail-grid-container-right.mobile-open .menu-hint-tab-right::before {
                    content: "▶" !important;
                    color: #000 !important;
                    transform: translate(-50%, -50%) !important;
                }
