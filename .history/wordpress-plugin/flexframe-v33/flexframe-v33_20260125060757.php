...
function flexframe_save_primary_color() {
    ...
    // Update player BUTTON color to match primary color (background of buttons)
    update_option('flexframe_player_button_color', $primary_color);
    ...
    update_option('flexframe_directional_light_color', $primary_color);
    ...
    wp_cache_delete('flexframe_player_button_color', 'options');
    wp_cache_delete('flexframe_spinner_color', 'options');
    wp_cache_delete('flexframe_directional_light_color', 'options');
