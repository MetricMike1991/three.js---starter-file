...
function flexframe_save_primary_color() {
    ...
    // Log the update
    flexframe_log('Primary color updated via Theme Editor', ['color' => $primary_color]);
    
    wp_send_json_success(['message' => 'Primary color saved successfully', 'color' => $primary_color]);
}
