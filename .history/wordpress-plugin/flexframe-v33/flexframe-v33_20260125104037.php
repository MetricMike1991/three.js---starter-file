...
define('FLEXFRAME_VERSION', '1.33.10');
define('FLEXFRAME_PLUGIN_DIR', plugin_dir_path(__FILE__));
define('FLEXFRAME_PLUGIN_URL', plugin_dir_url(__FILE__));

// Log plugin initialization
flexframe_log('Plugin loaded', array('version' => '1.33.10', 'plugin_url' => plugin_dir_url(__FILE__)));
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            @media screen and (max-width: 768px) {
                ...
                /* Smaller background logo on mobile - 30% smaller */
                ...
                .info-step-item {
                    background-color: rgba(' . $mobile_info_bg_rgb[0] . ', ' . $mobile_info_bg_rgb[1] . ', ' . $mobile_info_bg_rgb[2] . ', ' . $mobile_info_bg_opacity . ') !important;
                    border: 1px solid ' . $mobile_info_bg_color . ' !important;
                    border-radius: 8px !important;
                    backdrop-filter: blur(' . $mobile_info_blur . 'px) !important;
                    -webkit-backdrop-filter: blur(' . $mobile_info_blur . 'px) !important;
                }
                /* Mobile: Match info menu font sizes to left menu fonts */
                #flexframe-viewer-container .info-step-title,
                .thumbnail-dropdown-right .info-step-title,
                .info-step-title {
                    font-size: ' . $mobile_font_size_title . 'px !important;
                    line-height: 1.2 !important;
                }
                #flexframe-viewer-container .info-step-text,
                .thumbnail-dropdown-right .info-step-text,
                .info-step-text {
                    font-size: ' . $mobile_font_size_text . 'px !important;
                    line-height: 1.2 !important;
                }
            }
            ...
            @media screen and (max-width: 480px) {
                ...
                /* Even smaller background logo on small screens - 30% smaller */
                .flexframe-bg-watermark {
                ...
                /* Mobile small: Match info menu font sizes to left menu fonts */
                #flexframe-viewer-container .info-step-title,
                .thumbnail-dropdown-right .info-step-title,
                .info-step-title {
                    font-size: ' . max($mobile_font_size_title - 1, 6) . 'px !important;
                    line-height: 1.2 !important;
                }
                #flexframe-viewer-container .info-step-text,
                .thumbnail-dropdown-right .info-step-text,
                .info-step-text {
                    font-size: ' . max($mobile_font_size_text - 1, 6) . 'px !important;
                    line-height: 1.2 !important;
                }
            }
            }
        ...
        // Mobile UI Settings
        $mobile_font_size_title = absint(get_option('flexframe_mobile_font_size_title', 10));
        $mobile_font_size_text = absint(get_option('flexframe_mobile_font_size_text', 9));
        $mobile_info_bg_color = esc_attr(get_option('flexframe_mobile_info_bg_color', $menu_accent_color));
        $mobile_info_bg_opacity = floatval(get_option('flexframe_mobile_info_bg_opacity', 0.13));
        $mobile_info_blur = absint(get_option('flexframe_mobile_info_blur', 10));
        ...
        $mobile_info_bg_rgb = sscanf($mobile_info_bg_color, "#%02x%02x%02x");
        ...
        $settings_data = array(
            ...
            'mobileSettings' => array(
                'fontSizeTitle' => absint(get_option('flexframe_mobile_font_size_title', 10)),
                'fontSizeText' => absint(get_option('flexframe_mobile_font_size_text', 9)),
                'infoBgColor' => get_option('flexframe_mobile_info_bg_color', get_option('flexframe_menu_accent_color', '#f50000')),
                'infoBgOpacity' => floatval(get_option('flexframe_mobile_info_bg_opacity', 0.13)),
                'infoBlur' => absint(get_option('flexframe_mobile_info_blur', 10))
            ),
