...
function flexframe_settings_page() {
                    ...
                    <div class="flexframe-step-content" style="display: none;">
                        ...
                        <div class="flexframe-logo-color-reference">
                            <div class="logo-reference-header">
                                ...
                                <strong><?php _e('Your Logo (for color reference)', 'flexframe-viewer'); ?></strong>
                            </div>
                            ...
                            <p class="logo-reference-hint">
                                ...
                                <?php _e('Tip: Use your browser\'s eyedropper tool in the color picker to sample colors directly from your logo!', 'flexframe-viewer'); ?>
                            </p>
                        </div>
                        <?php endif; ?>
    ...
    <style>
        ...
        .logo-reference-preview {
            ...
            justify-content: center;
            align-items: center;
            background: linear-gradient(45deg, #f0f0f0 25%, #fafafa 25%, #fafafa 50%, #f0f0f0 50%, #f0f0f0 75%, #fafafa 75%);
