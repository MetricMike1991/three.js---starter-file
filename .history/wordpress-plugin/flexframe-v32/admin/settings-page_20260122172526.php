    ...
    <div class="wrap">
        ...
        <div class="flexframe-settings-container">
            ...
            <form method="post" action="options.php" id="flexframe-settings-form">
                ...
                <div class="flexframe-step-section collapsed">
                    ...
                    <div class="flexframe-step-content" style="display: none;">
                        ...
                        <p class="description" style="margin-top: 16px;">
                            ...
                            <?php _e('Need more control? Expand Step 5 below for advanced theme customization options.', 'flexframe-viewer'); ?>
                        </p>
                    </div>
                </div>
                
                <!-- Step 5: Advanced Theme Options & Custom Settings -->
                <div class="flexframe-step-section collapsed">
                    <div class="flexframe-step-header" data-step="5">
                        <span class="step-number">5</span>
                        <h2><?php _e('Advanced Theme Options & Custom Settings', 'flexframe-viewer'); ?></h2>
                        <span class="step-toggle-icon dashicons dashicons-arrow-down-alt2"></span>
                        <button type="submit" class="button button-primary step-save-btn">
                            <span class="dashicons dashicons-saved"></span><?php _e('Save Settings', 'flexframe-viewer'); ?>
                        </button>
                    ...
                    <div class="flexframe-step-content" style="display: none;">
                        <p class="step-description">
                            <?php _e('Fine-tune every aspect of your 3D viewer appearance including UI colors, materials, equipment settings, backgrounds, and particle effects.', 'flexframe-viewer'); ?>
                        </p>
                ...
                <!-- Step 6: Custom Exercise Library -->
                <div class="flexframe-step-section collapsed">
                    <div class="flexframe-step-header" data-step="6">
                        <span class="step-number">6</span>
                        <h2><?php _e('Custom Exercise Library', 'flexframe-viewer'); ?></h2>
                        <span class="step-toggle-icon dashicons dashicons-arrow-down-alt2"></span>
                        <button type="submit" class="button button-primary step-save-btn">
                            <span class="dashicons dashicons-saved"></span><?php _e('Save Settings', 'flexframe-viewer'); ?>
                        </button>
                            ...
                            <div class="flexframe-exercise-library">
                                <div class="exercise-library-header">
                                    <div class="exercise-search-box">
                                        <input type="text" id="exercise-search-step6" placeholder="<?php _e('Search exercises...', 'flexframe-viewer'); ?>" />
                                    </div>
                                    <div class="exercise-bulk-actions">
                                        <button type="button" class="button" id="show-all-exercises-step6"><?php _e('Show All', 'flexframe-viewer'); ?></button>
                                        <button type="button" class="button" id="hide-all-exercises-step6"><?php _e('Hide All', 'flexframe-viewer'); ?></button>
                                    </div>
                                </div>
                                
                                <div class="exercise-list-container">
                                    <div id="exercise-list-step6" class="exercise-list">
                                ...
                                <!-- Hidden inputs already exist in Step 1, these are just for reference -->
                            </div>
    ...
    jQuery(document).ready(function($) {
        ...
        $('input[name="flexframe_material_mode"]').on('change', function() {
            ...
            if (mode === 'preset') {
                ...
                // Auto-expand Step 5 when Custom Theme is selected
                var $step5 = $('.flexframe-step-header[data-step="5"]').closest('.flexframe-step-section');
                if ($step5.hasClass('collapsed')) {
                    $step5.removeClass('collapsed');
                    $step5.find('.flexframe-step-content').slideDown(200);
                }
            }
        });
