                            ...
                            <div class="custom-panel-content" id="workout-ai-coach-content">
                                ...
                                <table class="form-table" role="presentation">
                                    <tr>
                                        ...
                                        <td>
                                            <label><input type="checkbox" name="flexframe_ai_coach_enabled" value="1" <?php checked($ai_enabled); ?>>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label><input type="checkbox" name="flexframe_ai_coach_public" value="1" <?php checked($ai_public); ?>>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label><input type="checkbox" name="flexframe_ai_coach_chat_enabled" value="1" <?php checked($ai_chat_enabled); ?>>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label><input type="checkbox" name="flexframe_ai_coach_wod_enabled" value="1" <?php checked($ai_wod_enabled); ?>>
