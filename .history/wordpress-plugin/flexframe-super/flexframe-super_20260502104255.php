...
function flexframe_handle_coach_chat(WP_REST_Request $request) {
    ...
    if (!$chat_admin_on && !in_array($req_mode_raw, array('generate', 'wod'), true)) {
        return new WP_Error('flexframe_chat_disabled', 'Free-form chat is disabled. Use the form + Generate Now.', array('status' => 403));
    }
