...
(function () {
    ...
    function handleAction(action) {
        ...
        if (action === 'ai-image') {
            // Placeholder action — will be wired up to an AI image generator later.
            addAssistantMessage("AI Image generation is coming soon. For now, hit Generate Now to build your workout, or WOD for a surprise.");
            return;
        }
        if (action === 'chat') {
            if (!profile) {
