...
function flexframe_workout_builder_shortcode($atts) {
    ...
    <div id="flexframe-ai-coach" class="ffc-root">
        ...
        <div class="ffc-panel" role="dialog" aria-label="FlexFrame Coach chat">
            ...
            <div class="ffc-chips">
                <button type="button" class="ffc-chip" data-prompt="Give me today's WOD (Workout of the Day) — surprise me with a balanced, full-body session for an intermediate lifter, around 45 minutes, full gym access.">WOD</button>
