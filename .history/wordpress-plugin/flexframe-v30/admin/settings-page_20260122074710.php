...
function flexframe_settings_page() {
                            ...
                            <div class="custom-panel-section">
                                ...
                                <div class="custom-panel-content" id="background-settings-content">
                                    <div class="flexframe-custom-settings">
                                        ...
                                        $bg_logo_pos_y = get_option('flexframe_bg_logo_pos_y', 20);
                                        ?>
                                        ...
                                        <div class="flexframe-bg-logo-options" id="bg_logo_options" style="<?php echo ($bg_logo_enabled && !empty($logo_url)) ? '' : 'display:none;'; ?>">
                                            ...
                                            <div class="flexframe-watermark-preview-container">
                                                <label><?php _e('Position Preview', 'flexframe-viewer'); ?></label>
                                                <div class="watermark-preview-box" id="watermark_preview_box">
                                                    <div class="watermark-preview-logo" id="watermark_preview_logo" style="
                                                        left: <?php echo esc_attr($bg_logo_pos_x); ?>%;
                                                        top: <?php echo esc_attr($bg_logo_pos_y); ?>%;
                                                    ...
                                                    <div class="preview-model-placeholder">
    ...
    jQuery(document).ready(function($) {
        ...
        // Background logo sliders with preview update
        function updateWatermarkPreview() {
            var posX = $('#flexframe_bg_logo_pos_x').val();
            var posY = $('#flexframe_bg_logo_pos_y').val();
            var opacity = $('#flexframe_bg_logo_opacity').val();
            
            $('#watermark_preview_logo').css({
                'left': posX + '%',
                'top': posY + '%',
                'opacity': opacity
            });
