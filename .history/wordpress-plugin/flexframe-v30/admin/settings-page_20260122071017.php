                                ...
                                <div class="custom-panel-content" id="background-settings-content">
                                    <div class="flexframe-custom-settings">
                                        ...
                                        <div class="flexframe-subsection-divider">
                                            <h5><span class="dashicons dashicons-format-image"></span> <?php _e('Background Logo Watermark', 'flexframe-viewer'); ?></h5>
                                        </div>
                                        ...
                                        <div class="flexframe-bg-logo-options" id="bg_logo_options" style="<?php echo ($bg_logo_enabled && !empty($logo_url)) ? '' : 'display:none;'; ?>">
                                            <div class="flexframe-setting-row">
                                                ...
                                                <input type="range" id="flexframe_bg_logo_size" name="flexframe_bg_logo_size" value="<?php echo esc_attr($bg_logo_size); ?>" min="50" max="400" step="10" />
                                            ...
                                            <div class="flexframe-setting-row">
                                                ...
                                                <input type="range" id="flexframe_bg_logo_opacity" name="flexframe_bg_logo_opacity" value="<?php echo esc_attr($bg_logo_opacity); ?>" min="0.05" max="0.5" step="0.05" />
                                                <span class="range-value" id="bg_logo_opacity_value"><?php echo esc_html($bg_logo_opacity * 100); ?>%</span>
                                            </div>
                                            
                                            <p class="description">
                                                <?php _e('💡 Your logo will appear as a subtle watermark centered in the upper area of the viewer.', 'flexframe-viewer'); ?>
                                            </p>
                                        </div>
                                    </div>
                                </div>
