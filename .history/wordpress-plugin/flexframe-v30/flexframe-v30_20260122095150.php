...
define('FLEXFRAME_VERSION', '1.30.3');
...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $thumbnail_label_opacity = floatval(get_option('flexframe_thumbnail_label_opacity', 0.85));
        ...
        $ui_css .= '
            ...
            /* Thumbnail label gradient uses primary color */
            #flexframe-viewer-container .thumbnail-label,
            .thumbnail-dropdown .thumbnail-label,
            .thumbnail-label {
                background: linear-gradient(rgba(' . $primary_rgb[0] . ', ' . $primary_rgb[1] . ', ' . $primary_rgb[2] . ', 0.85), transparent) !important;
            }
        ';
