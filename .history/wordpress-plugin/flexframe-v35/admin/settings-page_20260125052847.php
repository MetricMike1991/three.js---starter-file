...
function flexframe_register_settings() {
    ...
    // ========== UI Settings (Step 5) - COMMENTED OUT since Step 5 was removed ==========
    // These settings are now managed via Theme Editor or Apply Theme button only
    /*
    // Loading Spinner
    ...
    */
    // End of commented Step 5 settings
}
add_action('admin_init', 'flexframe_register_settings');

/**
 * Comment out the preserve filter - not needed anymore
 */
/*
...
$step5_settings = array(
    ...
    'flexframe_bg_opacity', 'flexframe_ambient_intensity', 'flexframe_ambient_color', 'flexframe_directional_intensity',
