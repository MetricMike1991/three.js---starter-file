...
/**
 * Preserve existing values for settings that don't have form fields
 * This prevents theme settings from being overwritten when saving Steps 1-4
 */
function flexframe_preserve_theme_settings($value, $option) {
    // List of settings that are in Step 5 (removed from form)
    $step5_settings = array(
    ...
    // If this is a Step 5 setting and it's not in the POST data, preserve existing value
    if (in_array($option, $step5_settings) && !isset($_POST[$option])) {
...
// Add filter for each Step 5 setting
$step5_settings = array(
    'flexframe_spinner_color', 'flexframe_use_logo_loader', 'flexframe_logo_loader_animation', 
    'flexframe_logo_loader_size', 'flexframe_player_bg_color', 'flexframe_player_bg_opacity',
    'flexframe_player_button_bg_color', 'flexframe_player_button_bg_opacity', 'flexframe_player_icon_color',
    'flexframe_player_accent_color', 'flexframe_player_always_visible', 'flexframe_menu_bg_color',
    'flexframe_menu_bg_opacity', 'flexframe_menu_text_color', 'flexframe_menu_text_opacity',
    'flexframe_menu_accent_color', 'flexframe_thumbnail_label_color', 'flexframe_thumbnail_label_opacity',
    'flexframe_hide_right_menu', 'flexframe_show_screenshot_button', 'flexframe_skin_color',
    'flexframe_skin_opacity', 'flexframe_skin_roughness', 'flexframe_skin_metalness',
    'flexframe_skin_transmission', 'flexframe_skin_thickness', 'flexframe_skin_ior',
    'flexframe_skin_env_intensity', 'flexframe_bg_gradient_top', 'flexframe_bg_gradient_bottom',
    'flexframe_bg_opacity', 'flexframe_bg_logo_enabled', 'flexframe_bg_logo_size',
    'flexframe_bg_logo_opacity', 'flexframe_bg_logo_pos_x', 'flexframe_bg_logo_pos_y',
    'flexframe_ambient_intensity', 'flexframe_ambient_color', 'flexframe_directional_intensity',
    'flexframe_directional_color', 'flexframe_directional_pos_x', 'flexframe_directional_pos_y',
    'flexframe_directional_pos_z', 'flexframe_particles_enabled', 'flexframe_particles_count',
    'flexframe_particles_size', 'flexframe_particles_color', 'flexframe_particles_opacity',
    'flexframe_particles_speed'
);

foreach ($step5_settings as $setting) {
    add_filter('pre_update_option_' . $setting, 'flexframe_preserve_theme_settings', 10, 2);
}
...
function flexframe_settings_page() {
        ...
        <div class="flexframe-settings-container">
            ...
            <form method="post" action="options.php" id="flexframe-settings-form">
                    ...
                    <div class="flexframe-step-content" style="display: none;">
                        ...
                        <div class="flexframe-getting-started">
                            <div class="getting-started-header">
                                <span class="getting-started-icon">Ã°Å¸Å¡â‚¬</span>
                            ...
                            <div class="flexframe-shortcode-box">
                                ...
                                <span class="copy-success" style="display: none; color: #00a32a; margin-left: 8px;">Ã¢Å“â€œ <?php _e('Copied!', 'flexframe-viewer'); ?></span>
                            </div>
                        ...
                        <div class="flexframe-viewer-url-setting">
                            ...
                            <p class="description" id="flexframe-url-status">
                                <?php if (!empty($viewer_page_url)): ?>
                                    <span style="color: #00a32a; font-size: 14px;">Ã¢Å“â€œ <?php _e('Viewer page URL is set.', 'flexframe-viewer'); ?></span>
                                    <a href="<?php echo esc_url($viewer_page_url); ?>" target="_blank" class="button button-secondary" style="margin-left: 12px;"><?php _e('View Page Ã¢â€ â€™', 'flexframe-viewer'); ?></a>
                                <?php else: ?>
                                    <span style="color: #d63638;">Ã¢Å¡Â  <?php _e('No viewer page set. Create one above or paste your URL here.', 'flexframe-viewer'); ?></span>
                                <?php endif; ?>
                            </p>
                        </div>
                        ...
                        <div class="flexframe-shortcode-options">
                            ...
                            <div class="shortcode-options-content" style="display: none;">
                                ...
                                <p class="description" style="margin-top: 12px;">
                                    <?php _e('Ã°Å¸â€™Â¡ Available exercises: barbell_back_squat, barbell_deadlift, bench_press, seated_lat_pulldown, sumo_deadlift', 'flexframe-viewer'); ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flexframe-library-section">
                            <div class="library-section-header">
                                <span class="library-icon">Ã°Å¸â€œÅ¡</span>
                            ...
                            <p class="description" style="margin-top: 16px;">
                                <?php _e('Ã°Å¸â€™Â¡ Tip: Use the direct links to share specific exercises on social media or in emails. Hidden exercises won\'t appear in the exercise menu for your users.', 'flexframe-viewer'); ?>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flexframe-step-content" style="display: none;">
                        ...
                        <div class="flexframe-advanced-toggle">
                            <button type="button" class="button-link" id="toggle-logo-advanced">
                                <?php _e('Ã¢â€“Â¶ Advanced Logo Settings', 'flexframe-viewer'); ?>
                            </button>
                        </div>
                        <div class="flexframe-advanced-settings" id="logo-advanced-settings" style="display:none;">
                            ...
                            <div class="flexframe-bg-logo-info-box">
                                ...
                                <div class="info-content">
                                    ...
                                    <p class="description"><?php _e('To add your logo as a watermark on the viewer background, go to Step 4 Ã¢â€ â€™ Select "Custom Theme" Ã¢â€ â€™ Scene Background section.', 'flexframe-viewer'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flexframe-step-section collapsed">
                    ...
                    <div class="flexframe-step-content" style="display: none;">
                        <p class="step-description">
                            <?php _e('Choose your main brand color. This will be applied to accent elements like bumper plates, kettlebells, and trim colors on machines Ã¢â‚¬â€ helping the 3D models match your gym\'s branding.', 'flexframe-viewer'); ?>
                        </p>
                                ...
                                <select id="flexframe_material_preset" name="flexframe_material_preset" class="preset-theme-select">
                                    <optgroup label="<?php _e('Built-in Themes', 'flexframe-viewer'); ?>">
                                        ...
                                        <option value="random" <?php selected($material_preset, 'random'); ?>>
                                            <?php _e('Ã°Å¸Å½Â² Random Theme', 'flexframe-viewer'); ?>
                                        </option>
                                    </optgroup>
                ...
                <div class="flexframe-step-section collapsed">
                    <div class="flexframe-step-header" data-step="5">
                        ...
                        <h2><?php _e('Customize Your Theme', 'flexframe-viewer'); ?></h2>
                        <span class="step-toggle-icon dashicons dashicons-arrow-down-alt2"></span>
                    </div>
                    <div class="flexframe-step-content" style="display: none;">
                        <p class="step-description">
                            <?php _e('Use the live Theme Editor to customize all UI settings, colors, and materials in real-time. Changes are saved automatically.', 'flexframe-viewer'); ?>
                        </p>
                        
                        <div style="text-align: center; padding: 60px 40px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 12px; margin: 20px 0;">
                            <div style="margin-bottom: 30px;">
                                <span class="dashicons dashicons-admin-customizer" style="font-size: 80px; color: #fff; opacity: 0.9;"></span>
                            </div>
                            <h3 style="color: #fff; margin: 0 0 15px 0; font-size: 24px;">
                                <?php _e('Live Theme Editor', 'flexframe-viewer'); ?>
                            </h3>
                            <p style="color: rgba(255,255,255,0.9); margin: 0 0 30px 0; font-size: 16px; max-width: 600px; margin-left: auto; margin-right: auto;">
                                <?php _e('Click the button below to open your viewer with the Theme Editor interface. Customize UI elements, player controls, menus, and 3D model materials with instant visual feedback.', 'flexframe-viewer'); ?>
                            </p>
                            <?php
                            $viewer_page_url = get_option('flexframe_viewer_page_url', '');
                            if (!empty($viewer_page_url)) :
                                $theme_editor_url = add_query_arg('openThemeEditor', '1', $viewer_page_url);
                            ?>
                                <a href="<?php echo esc_url($theme_editor_url); ?>" target="_blank" class="button button-hero" style="background: #fff; color: #667eea; border: none; padding: 15px 40px; font-size: 18px; font-weight: 600; box-shadow: 0 4px 15px rgba(0,0,0,0.2); transition: all 0.3s ease; text-decoration: none; display: inline-flex; align-items: center; gap: 10px;">
                                    <span class="dashicons dashicons-art" style="font-size: 24px;"></span>
                                    <?php _e('Open Theme Editor', 'flexframe-viewer'); ?>
                                </a>
                                <p style="color: rgba(255,255,255,0.8); margin: 20px 0 0 0; font-size: 13px;">
                                    <?php _e('Ã°Å¸â€™Â¡ Tip: You can also press', 'flexframe-viewer'); ?> <kbd style="background: rgba(255,255,255,0.2); padding: 4px 8px; border-radius: 4px; font-family: monospace;">T</kbd> <?php _e('while viewing your exercises to open the Theme Editor.', 'flexframe-viewer'); ?>
                                </p>
                            <?php else : ?>
                                <div style="background: rgba(255,255,255,0.1); padding: 20px; border-radius: 8px; margin-top: 20px;">
                                    <span class="dashicons dashicons-warning" style="font-size: 48px; color: #ffd700; margin-bottom: 15px;"></span>
                                    <p style="color: #fff; margin: 0; font-size: 16px;">
                                        <?php _e('Please set your viewer page URL in Step 1 to use the Theme Editor.', 'flexframe-viewer'); ?>
                                    </p>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; border-left: 4px solid #667eea; margin-top: 30px;">
                            <h4 style="margin: 0 0 10px 0; color: #333;">
                                ...
                                <?php _e('What You Can Customize:', 'flexframe-viewer'); ?>
                            </h4>
                            <ul style="margin: 0; padding-left: 20px; color: #666;">
                                <li><?php _e('Loading indicators and spinner colors', 'flexframe-viewer'); ?></li>
                                <li><?php _e('Player controls (colors, opacity, visibility)', 'flexframe-viewer'); ?></li>
                                <li><?php _e('Menu styles (background, text, accent colors)', 'flexframe-viewer'); ?></li>
                                <li><?php _e('Background settings and watermarks', 'flexframe-viewer'); ?></li>
                                <li><?php _e('3D model materials (skin, equipment, bones)', 'flexframe-viewer'); ?></li>
                                <li><?php _e('Lighting and particle effects', 'flexframe-viewer'); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="flexframe-button-row">
                    ...
                    <span id="export-success-message" style="display: none; color: #00a32a; margin-left: 10px; line-height: 30px;">
                        Ã¢Å“â€œ <?php _e('Settings copied to clipboard!', 'flexframe-viewer'); ?>
                    </span>
                </div>
            </form>
        </div>
    ...
    jQuery(document).ready(function($) {
        ...
        $('#apply-preset-theme').on('click', function() {
            ...
            console.log('[Theme Apply] Applying theme:', presetId, 'isCustom:', isCustomTheme);
            
            // Get theme settings
            var settings;
            if (isCustomTheme) {
                // Load custom preset and save it
                $.ajax({
                    url: ajaxurl,
                    type: 'POST',
                    data: {
                    ...
                    success: function(response) {
                        if (response.success && response.data && response.data.preset) {
                            applyThemeSettings(response.data.preset.settings, $btn);
                        } else {
                            console.error('[Theme Apply] Failed to load custom theme');
                            $btn.prop('disabled', false).html('<span class="dashicons dashicons-yes" style="margin-top: 4px;"></span> <?php _e('Apply Theme', 'flexframe-viewer'); ?>');
                        }
                    }
                });
            } else {
                ...
                if (preset) {
                    var primaryColor = $('#flexframe_primary_color').val() || '#2383cd';
                    settings = preset.isRandom ? generateRandomTheme(primaryColor) : preset.settings;
                    
                    // Replace 'primary' with actual color
                    var processedSettings = {};
                    for (var key in settings) {
                        processedSettings[key] = (settings[key] === 'primary') ? primaryColor : settings[key];
                    }
                    
                    applyThemeSettings(processedSettings, $btn);
                }
            }
        });
        
        // Apply theme settings directly via AJAX (bypasses form fields)
        function applyThemeSettings(settings, $btn) {
            console.log('[Theme Apply] Saving settings via AJAX:', settings);
            
            $.ajax({
                url: ajaxurl,
                type: 'POST',
                data: {
                    action: 'flexframe_apply_theme_directly',
                    settings: JSON.stringify(settings),
                    nonce: '<?php echo wp_create_nonce('flexframe_settings_nonce'); ?>'
                },
                success: function(response) {
                    console.log('[Theme Apply] AJAX response:', response);
                    if (response.success) {
                        $btn.html('<span class="dashicons dashicons-yes" style="margin-top: 4px; color: #46b450;"></span> <?php _e('Applied!', 'flexframe-viewer'); ?>');
                        setTimeout(function() {
                            location.reload();
                        }, 500);
                    } else {
                        $btn.prop('disabled', false).html('<span class="dashicons dashicons-yes" style="margin-top: 4px;"></span> <?php _e('Apply Theme', 'flexframe-viewer'); ?>');
                        alert('Error applying theme: ' + (response.data || 'Unknown error'));
                    }
                },
                error: function(xhr, status, error) {
                    console.error('[Theme Apply] AJAX error:', error);
                    $btn.prop('disabled', false).html('<span class="dashicons dashicons-yes" style="margin-top: 4px;"></span> <?php _e('Apply Theme', 'flexframe-viewer'); ?>');
        ...
        $('#toggle-logo-advanced').on('click', function() {
            ...
            if ($settings.is(':visible')) {
                ...
                $btn.html('Ã¢â€“Â¶ Advanced Logo Settings');
            } else {
        ...
        $('#flexframe-create-viewer-page').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        $status.html('<span style="color: #00a32a;">Ã¢Å“â€œ ' + response.data.message + '</span>');
                        $('#flexframe_viewer_page_url').val(response.data.url);
                        
                        // Update the URL status section below the input
                        $('#flexframe-url-status').html(
                            '<span style="color: #00a32a; font-size: 14px;">Ã¢Å“â€œ Viewer page URL is set.</span> ' +
                            '<a href="' + response.data.url + '" target="_blank" class="button button-secondary" style="margin-left: 12px;">View Page Ã¢â€ â€™</a> ' +
                        ...
                        setTimeout(function() {
                            $status.html(
                                '<span style="color: #00a32a;">Ã¢Å“â€œ Page created!</span> '
                            );
                        }, 1500);
                    } else {
                        $status.html('<span style="color: #d63638;">Ã¢Å“â€” ' + response.data.message + '</span>');
                    }
                ...
                error: function() {
                    $status.html('<span style="color: #d63638;">Ã¢Å“â€” An error occurred. Please try again.</span>');
                    $btn.prop('disabled', false).html('<span class="dashicons dashicons-plus-alt" style="margin-top: 3px;"></span> Create Exercise Viewer Page');
                }
            });
        });
        ...
        function renderExerciseList(filter) {
            ...
            filteredExercises.forEach(function(exercise) {
                ...
                if (displayThumb) {
                    ...
                    html += '            <span class="no-thumbnail">Ã°Å¸â€œÂ·</span>';
                }
                html += '        </div>';
                ...
                if (muscleGroups) {
                    html += '            <span>Ã°Å¸â€™Âª ' + muscleGroups + '</span>';
                }
                if (equipment) {
                    html += '            <span>Ã°Å¸Ââ€¹Ã¯Â¸Â ' + equipment + '</span>';
                }
                html += '        </div>';
                html += '    </div>';
        ...
        $(document).on('click', '.remove-thumbnail-btn', function(e) {
            ...
            if (defaultThumb) {
                ...
                $thumb.html('<span class="no-thumbnail">Ã°Å¸â€œÂ·</span>');
            }
