        ...
        <div class="flexframe-settings-container">
            ...
            <form method="post" action="options.php" id="flexframe-settings-form">
                    ...
                    <div class="flexframe-step-content" style="display: none;">
                        ...
                        <div class="flexframe-getting-started">
                            <div class="getting-started-header">
                                <span class="getting-started-icon">ðŸš€</span>
                            ...
                            <div class="flexframe-shortcode-box">
                                ...
                                <span class="copy-success" style="display: none; color: #00a32a; margin-left: 8px;">âœ“ <?php _e('Copied!', 'flexframe-viewer'); ?></span>
                            </div>
                        ...
                        <div class="flexframe-viewer-url-setting">
                            ...
                            <p class="description" id="flexframe-url-status">
                                <?php if (!empty($viewer_page_url)): ?>
                                    <span style="color: #00a32a; font-size: 14px;">âœ“ <?php _e('Viewer page URL is set.', 'flexframe-viewer'); ?></span>
                                    <a href="<?php echo esc_url($viewer_page_url); ?>" target="_blank" class="button button-secondary" style="margin-left: 12px;"><?php _e('View Page â†’', 'flexframe-viewer'); ?></a>
                                <?php else: ?>
                                    <span style="color: #d63638;">âš  <?php _e('No viewer page set. Create one above or paste your URL here.', 'flexframe-viewer'); ?></span>
                                <?php endif; ?>
                            </p>
                        </div>
                        ...
                        <div class="flexframe-shortcode-options">
                            ...
                            <div class="shortcode-options-content" style="display: none;">
                                ...
                                <p class="description" style="margin-top: 12px;">
                                    <?php _e('ðŸ’¡ Available exercises: barbell_back_squat, barbell_deadlift, bench_press, seated_lat_pulldown, sumo_deadlift', 'flexframe-viewer'); ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flexframe-library-section">
                            ...
                            <p class="description" style="margin-top: 16px;">
                                <?php _e('ðŸ’¡ Tip: Use the direct links to share specific exercises on social media or in emails. Hidden exercises won\'t appear in the exercise menu for your users.', 'flexframe-viewer'); ?>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flexframe-step-content" style="display: none;">
                        ...
                        <div class="flexframe-advanced-toggle">
                            <button type="button" class="button-link" id="toggle-logo-advanced">
                                <?php _e('â–¶ Advanced Logo Settings', 'flexframe-viewer'); ?>
                            </button>
                        </div>
                        <div class="flexframe-advanced-settings" id="logo-advanced-settings" style="display:none;">
                            ...
                            <div class="flexframe-bg-logo-info-box">
                                ...
                                <div class="info-content">
                                    ...
                                    <p class="description"><?php _e('To add your logo as a watermark on the viewer background, go to Step 4 â†’ Select "Custom Theme" â†’ Scene Background section.', 'flexframe-viewer'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flexframe-step-section collapsed">
                    ...
                    <div class="flexframe-step-content" style="display: none;">
                        <p class="step-description">
                            <?php _e('Choose your main brand color. This will be applied to accent elements like bumper plates, kettlebells, and trim colors on machines â€” helping the 3D models match your gym\'s branding.', 'flexframe-viewer'); ?>
                        </p>
                                ...
                                <select id="flexframe_material_preset" name="flexframe_material_preset" class="preset-theme-select">
                                    <optgroup label="<?php _e('Built-in Themes', 'flexframe-viewer'); ?>">
                                        ...
                                        <option value="random" <?php selected($material_preset, 'random'); ?>>
                                            <?php _e('ðŸŽ² Random Theme', 'flexframe-viewer'); ?>
                                        </option>
                                    </optgroup>
                        ...
                        <div style="text-align: center; padding: 60px 40px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 12px; margin: 20px 0;">
                            ...
                            ?>
                                ...
                                <p style="color: rgba(255,255,255,0.8); margin: 20px 0 0 0; font-size: 13px;">
                                    <?php _e('ðŸ’¡ Tip: You can also press', 'flexframe-viewer'); ?> <kbd style="background: rgba(255,255,255,0.2); padding: 4px 8px; border-radius: 4px; font-family: monospace;">T</kbd> <?php _e('while viewing your exercises to open the Theme Editor.', 'flexframe-viewer'); ?>
                                </p>
                            <?php else : ?>
                ...
                <div class="flexframe-button-row">
                    ...
                    <span id="export-success-message" style="display: none; color: #00a32a; margin-left: 10px; line-height: 30px;">
                        âœ“ <?php _e('Settings copied to clipboard!', 'flexframe-viewer'); ?>
                    </span>
                </div>
            </form>
        </div>
    ...
    jQuery(document).ready(function($) {
        ...
        $('#toggle-logo-advanced').on('click', function() {
            ...
            if ($settings.is(':visible')) {
                ...
                $btn.html('â–¶ Advanced Logo Settings');
            } else {
        ...
        $('#flexframe-create-viewer-page').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#flexframe-url-status').html(
                            '<span style="color: #00a32a; font-size: 14px;">âœ“ Viewer page URL is set.</span> ' +
                            '<a href="' + response.data.url + '" target="_blank" class="button button-secondary" style="margin-left: 12px;">View Page â†’</a> ' +
                        ...
                        setTimeout(function() {
                            $status.html(
                                '<span style="color: #00a32a;">âœ“ Page created!</span> '
                            );
                        }, 1500);
                    } else {
                ...
                error: function() {
                    $status.html('<span style="color: #d63638;">âœ— An error occurred. Please try again.</span>');
                    $btn.prop('disabled', false).html('<span class="dashicons dashicons-plus-alt" style="margin-top: 3px;"></span> Create Exercise Viewer Page');
                }
            });
        });
        ...
        function renderExerciseList(filter) {
            ...
            filteredExercises.forEach(function(exercise) {
                ...
                if (displayThumb) {
                    ...
                    html += '            <span class="no-thumbnail">ðŸ“·</span>';
                }
                html += '        </div>';
                ...
                if (muscleGroups) {
                    html += '            <span>ðŸ’ª ' + muscleGroups + '</span>';
                }
                if (equipment) {
                    html += '            <span>ðŸ‹ï¸ ' + equipment + '</span>';
                }
                html += '        </div>';
                html += '    </div>';
        ...
        $(document).on('click', '.remove-thumbnail-btn', function(e) {
            ...
            if (defaultThumb) {
                ...
                $thumb.html('<span class="no-thumbnail">ðŸ“·</span>');
            }
