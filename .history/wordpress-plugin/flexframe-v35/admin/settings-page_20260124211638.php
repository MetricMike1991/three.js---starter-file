                        ...
                        <div style="text-align: center; padding: 60px 40px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 12px; margin: 20px 0;">
                            ...
                            ?>
                                ...
                                <p style="color: rgba(255,255,255,0.8); margin: 20px 0 0 0; font-size: 13px;">
                                    <?php _e('💡 Tip: You can also press', 'flexframe-viewer'); ?> <kbd style="background: rgba(255,255,255,0.2); padding: 4px 8px; border-radius: 4px; font-family: monospace;">T</kbd> <?php _e('while viewing your exercises to open the Theme Editor.', 'flexframe-viewer'); ?>
                                </p>
                            <?php else : ?>
