...
define('FLEXFRAME_VERSION', '1.35.0');
define('FLEXFRAME_PLUGIN_DIR', plugin_dir_path(__FILE__));
define('FLEXFRAME_PLUGIN_URL', plugin_dir_url(__FILE__));

// Log plugin initialization
flexframe_log('Plugin loaded', array('version' => '1.35.0', 'plugin_url' => plugin_dir_url(__FILE__)));
...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        wp_register_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/main.bundle.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
...
function flexframe_save_primary_color() {
    ...
    // Update spinner/loading indicator color to match primary color
...
/**
 * AJAX handler to apply theme directly (without form fields)
 */
function flexframe_apply_theme_directly() {
    // Verify nonce
    check_ajax_referer('flexframe_settings_nonce', 'nonce');
    ...
    flexframe_log('Applying theme directly via AJAX', ['settings_count' => count($settings)]);
    
    // Map of JavaScript keys to WordPress option names
    $option_map = [
        // Primary
        ...
        'spinnerColor' => 'flexframe_spinner_color',
        'use_logo_loader' => 'flexframe_use_logo_loader',
        'useLogoLoader' => 'flexframe_use_logo_loader',
        'logo_loader_animation' => 'flexframe_logo_loader_animation',
        'logoLoaderAnimation' => 'flexframe_logo_loader_animation',
        'logo_loader_size' => 'flexframe_logo_loader_size',
        'logoLoaderSize' => 'flexframe_logo_loader_size',
        // Player
        'player_bg_color' => 'flexframe_player_bg_color',
        'playerBgColor' => 'flexframe_player_bg_color',
        'player_bg_opacity' => 'flexframe_player_bg_opacity',
        'playerBgOpacity' => 'flexframe_player_bg_opacity',
        'player_button_bg_color' => 'flexframe_player_button_bg_color',
        'playerButtonBgColor' => 'flexframe_player_button_bg_color',
        'player_button_bg_opacity' => 'flexframe_player_button_bg_opacity',
        'playerButtonBgOpacity' => 'flexframe_player_button_bg_opacity',
        'player_icon_color' => 'flexframe_player_icon_color',
        'playerIconColor' => 'flexframe_player_icon_color',
        'player_accent_color' => 'flexframe_player_accent_color',
        'playerAccentColor' => 'flexframe_player_accent_color',
        'player_always_visible' => 'flexframe_player_always_visible',
        'playerAlwaysVisible' => 'flexframe_player_always_visible',
        // Menu
        'menu_bg_color' => 'flexframe_menu_bg_color',
        'menuBgColor' => 'flexframe_menu_bg_color',
        'menu_bg_opacity' => 'flexframe_menu_bg_opacity',
        'menuBgOpacity' => 'flexframe_menu_bg_opacity',
        'menu_text_color' => 'flexframe_menu_text_color',
        'menuTextColor' => 'flexframe_menu_text_color',
        'menu_text_opacity' => 'flexframe_menu_text_opacity',
        'menuTextOpacity' => 'flexframe_menu_text_opacity',
        'menu_accent_color' => 'flexframe_menu_accent_color',
        'menuAccentColor' => 'flexframe_menu_accent_color',
        'hide_right_menu' => 'flexframe_hide_right_menu',
        'hideRightMenu' => 'flexframe_hide_right_menu',
        'show_screenshot_button' => 'flexframe_show_screenshot_button',
        'showScreenshotButton' => 'flexframe_show_screenshot_button',
        // Thumbnails
        'thumbnail_label_color' => 'flexframe_thumbnail_label_color',
        'thumbnailLabelColor' => 'flexframe_thumbnail_label_color',
        'thumbnail_label_opacity' => 'flexframe_thumbnail_label_opacity',
        'thumbnailLabelOpacity' => 'flexframe_thumbnail_label_opacity',
        // Skin
        'skin_color' => 'flexframe_skin_color',
        'skinColor' => 'flexframe_skin_color',
        'skin_opacity' => 'flexframe_skin_opacity',
        'skinOpacity' => 'flexframe_skin_opacity',
        'skin_roughness' => 'flexframe_skin_roughness',
        'skinRoughness' => 'flexframe_skin_roughness',
        'skin_metalness' => 'flexframe_skin_metalness',
        'skinMetalness' => 'flexframe_skin_metalness',
        'skin_transmission' => 'flexframe_skin_transmission',
        'skinTransmission' => 'flexframe_skin_transmission',
        'skin_thickness' => 'flexframe_skin_thickness',
        'skinThickness' => 'flexframe_skin_thickness',
        'skin_ior' => 'flexframe_skin_ior',
        'skinIor' => 'flexframe_skin_ior',
        'skin_env_intensity' => 'flexframe_skin_env_intensity',
        'skinEnvIntensity' => 'flexframe_skin_env_intensity',
        // Background
        'bg_gradient_top' => 'flexframe_bg_gradient_top',
        'bgGradientTop' => 'flexframe_bg_gradient_top',
        'bg_gradient_bottom' => 'flexframe_bg_gradient_bottom',
        'bgGradientBottom' => 'flexframe_bg_gradient_bottom',
        'bg_gradient_opacity' => 'flexframe_bg_opacity',
        'bgGradientOpacity' => 'flexframe_bg_opacity',
        // Background Logo
        'bg_logo_enabled' => 'flexframe_bg_logo_enabled',
        'bgLogoEnabled' => 'flexframe_bg_logo_enabled',
        'bg_logo_size' => 'flexframe_bg_logo_size',
        'bgLogoSize' => 'flexframe_bg_logo_size',
        'bg_logo_opacity' => 'flexframe_bg_logo_opacity',
        'bgLogoOpacity' => 'flexframe_bg_logo_opacity',
        'bg_logo_pos_x' => 'flexframe_bg_logo_pos_x',
        'bgLogoPosX' => 'flexframe_bg_logo_pos_x',
        'bg_logo_pos_y' => 'flexframe_bg_logo_pos_y',
        'bgLogoPosY' => 'flexframe_bg_logo_pos_y',
        // Lighting
        'ambient_intensity' => 'flexframe_ambient_intensity',
        'ambientIntensity' => 'flexframe_ambient_intensity',
        'ambient_color' => 'flexframe_ambient_color',
        'ambientColor' => 'flexframe_ambient_color',
        'directional_intensity' => 'flexframe_directional_intensity',
        'directionalIntensity' => 'flexframe_directional_intensity',
        'directional_color' => 'flexframe_directional_color',
        'directionalColor' => 'flexframe_directional_color',
        'directional_pos_x' => 'flexframe_directional_pos_x',
        'directionalPosX' => 'flexframe_directional_pos_x',
        'directional_pos_y' => 'flexframe_directional_pos_y',
        'directionalPosY' => 'flexframe_directional_pos_y',
        'directional_pos_z' => 'flexframe_directional_pos_z',
        'directionalPosZ' => 'flexframe_directional_pos_z',
        // Particles
        'particles_enabled' => 'flexframe_particles_enabled',
        'particlesEnabled' => 'flexframe_particles_enabled',
        'particles_count' => 'flexframe_particles_count',
        'particlesCount' => 'flexframe_particles_count',
        'particle_count' => 'flexframe_particles_count',
        'particleCount' => 'flexframe_particles_count',
        'particles_size' => 'flexframe_particles_size',
        'particlesSize' => 'flexframe_particles_size',
        'particle_size' => 'flexframe_particles_size',
        'particleSize' => 'flexframe_particles_size',
        'particles_color' => 'flexframe_particles_color',
        'particlesColor' => 'flexframe_particles_color',
        'particle_color' => 'flexframe_particles_color',
        'particleColor' => 'flexframe_particles_color',
        'particles_opacity' => 'flexframe_particles_opacity',
        'particlesOpacity' => 'flexframe_particles_opacity',
        'particle_opacity' => 'flexframe_particles_opacity',
        'particleOpacity' => 'flexframe_particles_opacity',
        'particles_speed' => 'flexframe_particles_speed',
        'particlesSpeed' => 'flexframe_particles_speed',
        'particle_speed' => 'flexframe_particles_speed',
        'particleSpeed' => 'flexframe_particles_speed',
    ];
    ...
    // Also update material preset selection
    if (isset($_POST['preset_name'])) {
        update_option('flexframe_material_preset', sanitize_text_field($_POST['preset_name']));
    }
    ...
    flexframe_log('Theme applied successfully', ['options_updated' => $updated_count]);
    
    wp_send_json_success([
        'message' => 'Theme applied successfully',
        'options_updated' => $updated_count
    ]);
}
add_action('wp_ajax_flexframe_apply_theme_directly', 'flexframe_apply_theme_directly');
