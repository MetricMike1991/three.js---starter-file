...
function flexframe_settings_page() {
    ...
    $skin_color = get_option('flexframe_skin_color', '#006eff');
    $skin_opacity = get_option('flexframe_skin_opacity', 0.53);
    $skin_roughness = get_option('flexframe_skin_roughness', 0.51);
    $skin_metalness = get_option('flexframe_skin_metalness', 0);
    $skin_transmission = get_option('flexframe_skin_transmission', 0.8);
    $skin_thickness = get_option('flexframe_skin_thickness', 0);
    $skin_ior = get_option('flexframe_skin_ior', 1.45);
