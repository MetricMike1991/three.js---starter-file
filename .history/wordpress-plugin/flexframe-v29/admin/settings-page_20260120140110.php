...
function flexframe_settings_page() {
    ...
    jQuery(document).ready(function($) {
        ...
        $('#apply-preset-theme').on('click', function() {
            ...
            $btn.html('<span class="dashicons dashicons-update spin" style="margin-top: 4px;"></span> <?php _e('Saving...', 'flexframe-viewer'); ?>');
            
            // Auto-submit the form to save settings
            setTimeout(function() {
                $('form#flexframe-settings-form').submit();
            }, 100);
        });
