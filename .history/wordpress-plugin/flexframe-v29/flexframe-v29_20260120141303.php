...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $skin_settings = array(
            'color' => get_option('flexframe_skin_color', '#006eff'),
            'opacity' => floatval(get_option('flexframe_skin_opacity', 0.53)),
            'roughness' => floatval(get_option('flexframe_skin_roughness', 0.51)),
            'metalness' => floatval(get_option('flexframe_skin_metalness', 0)),
            'transmission' => floatval(get_option('flexframe_skin_transmission', 0.8)),
            'thickness' => floatval(get_option('flexframe_skin_thickness', 0)),
            'ior' => floatval(get_option('flexframe_skin_ior', 1.45)),
