<?php
/**
 * Plugin Name: FlexFrame v36
 * Plugin URI: https://flexframe.com
 * Description: 3D interactive exercise viewer with customizable logo and materials - Theme Editor Update
 * Version: 1.36.0
 * Author: FlexFrame
...
define('FLEXFRAME_VERSION', '1.36.0');
define('FLEXFRAME_PLUGIN_DIR', plugin_dir_path(__FILE__));
define('FLEXFRAME_PLUGIN_URL', plugin_dir_url(__FILE__));

// Log plugin initialization
flexframe_log('Plugin loaded', array('version' => '1.36.0', 'plugin_url' => plugin_dir_url(__FILE__)));
...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        wp_register_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'viewer/assets/index-CNiJuqlG.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
