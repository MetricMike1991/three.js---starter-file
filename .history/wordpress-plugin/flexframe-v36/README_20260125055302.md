# FlexFrame Exercise Viewer v36 - WordPress Plugin

A 3D interactive exercise viewer plugin for WordPress with customizable logo and materials.

## Version 1.36.0 Changes
- Added Theme Editor with live primary color updates
- Primary color now updates animation player accent color and button background
- Primary color now updates spinner color
- Primary color now updates directional light color
- Improved real-time theme customization
