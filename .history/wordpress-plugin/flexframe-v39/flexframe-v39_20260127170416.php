...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            /* Hide all menu wrappers except search on ALL devices */
            #flexframe-viewer-container .thumbnail-grid-container .thumbnail-menu-wrapper {
                display: none !important;
            }
            #flexframe-viewer-container .thumbnail-grid-container .thumbnail-menu-wrapper:has(#searchToggle) {
                display: block !important;
            }
            
            /* Hide hover hint tab since we always show search */
            .menu-hint-tab {
                display: none !important;
            }
            
            /* Keep menu visible - no hover needed */
            ...
            @media screen and (max-width: 768px) {
                /* Adjust positioning for mobile - closer to edges */
                #flexframe-viewer-container .thumbnail-grid-container,
                .thumbnail-grid-container {
                    left: 8px !important;
                    top: 8px !important;
        ...
        wp_register_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-B9JCeggZ.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
