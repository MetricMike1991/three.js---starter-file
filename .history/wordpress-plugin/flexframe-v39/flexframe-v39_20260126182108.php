...
flexframe_log('Plugin loaded', array('version' => '1.39.0', 'plugin_url' => plugin_dir_url(__FILE__)));
...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        wp_enqueue_style(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-CiuFjnRJ.css',
            array(),
            FLEXFRAME_VERSION
        );
        ...
        $isolation_css = '
            ...
            .filter-clear-btn {
                ...
                border: 1px solid ' . $menu_accent_color . '66;
                padding: 2px 6px;
                border-radius: 3px;
                cursor: pointer;
                transition: all 0.2s;
            ...
            .filter-clear-btn:hover {
                background: ' . $menu_accent_color . '33;
                border-color: ' . $menu_accent_color . ';
            ...
            .filter-checkbox-label:hover {
                background-color: ' . $menu_accent_color . '22;
            }
            ...
            .filter-checkbox {
                ...
                -moz-appearance: none;
                appearance: none;
                border: 2px solid ' . $menu_accent_color . '66;
                border-radius: 2px;
                background: transparent;
                position: relative;
            }
            ...
            /* Force checkbox color in all browsers */
            #flexframe-viewer-container .filter-checkbox,
            #searchFiltersPanel .filter-checkbox,
            .search-filters-panel .filter-checkbox {
                accent-color: ' . $menu_accent_color . ' !important;
            }
            
            #flexframe-viewer-container .filter-checkbox:checked,
            #searchFiltersPanel .filter-checkbox:checked,
            .search-filters-panel .filter-checkbox:checked {
                accent-color: ' . $menu_accent_color . ' !important;
                background-color: ' . $menu_accent_color . ' !important;
                border-color: ' . $menu_accent_color . ' !important;
            }
        ...
        wp_register_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-BPmWsDA0.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
