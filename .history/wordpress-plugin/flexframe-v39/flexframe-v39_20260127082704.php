...
define('FLEXFRAME_VERSION', '1.39.85');
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            @media screen and (max-width: 768px) {
                ...
                /* Hide Exercises, Muscles, Equipment buttons on mobile - only show Search */
                #exercisesToggle,
                #musclesToggle,
                #equipmentToggle,
                #exercisesToggle + .thumbnail-dropdown,
                #musclesToggle + .thumbnail-dropdown,
                #equipmentToggle + .thumbnail-dropdown {
                    display: none !important;
                }
                /* Position and size Search button on mobile */
                #searchToggle {
                    position: fixed !important;
                    left: 8px !important;
                    top: 8px !important;
        ...
        wp_register_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-NvJ6kjK0.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
