...
define('FLEXFRAME_VERSION', '1.39.121');
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            @media screen and (max-width: 768px) {
                ...
                button.search-close-btn-mobile {
                    position: fixed !important;
                    right: 10px !important;
                    width: 32px !important;
                    height: 32px !important;
                ...
                button.search-close-btn-mobile svg {
                    width: 18px !important;
                    height: 18px !important;
                    fill: #ffffff !important;
                    filter: drop-shadow(0 1px 2px rgba(0, 0, 0, 0.4)) !important;
                }
                button.search-close-btn-mobile:hover,
                button.search-close-btn-mobile:active {
        ...
        wp_register_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-D6xePSkp.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
