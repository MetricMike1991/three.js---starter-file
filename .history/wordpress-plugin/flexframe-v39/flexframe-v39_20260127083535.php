...
define('FLEXFRAME_VERSION', '1.39.87');
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            @media screen and (max-width: 768px) {
                /* Hide entire thumbnail-grid-container on mobile except search */
                #flexframe-viewer-container .thumbnail-grid-container,
                .thumbnail-grid-container {
                    display: none !important;
                }
                /* Show only the search button wrapper on mobile */
        ...
        wp_register_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-BO6hLVlG.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
