...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            /* Hide hover hint tab since we're always showing search */
            .menu-hint-tab {
                display: none !important;
            }
            
            /* Disable hover to show menus - not needed with search-only approach */
        ...
        wp_register_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/assets/index-CHYnL3Ny.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
