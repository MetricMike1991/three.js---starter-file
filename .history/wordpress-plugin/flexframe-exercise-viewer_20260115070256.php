...
define('FLEXFRAME_VERSION', '1.2.1');
...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        // Add inline CSS for WordPress theme isolation - targeted approach
        $isolation_css = '
            /* Prevent WordPress theme pseudo-elements from interfering */
            .lil-gui *::before,
            .lil-gui *::after {
            ...
            /* Reset button styles that WordPress themes commonly override */
            ...
            /* Prevent theme link styles from affecting plugin */
            #flexframe-viewer-container a {
        ...
        wp_enqueue_script(
            ...
            FLEXFRAME_PLUGIN_URL . 'assets/js/index-DRZZprl_.js',
            array(),
            FLEXFRAME_VERSION,
            true
        );
