<?php
/**
 * Plugin Name: FlexFrame v34
 * Plugin URI: https://flexframe.com
 * Description: 3D interactive exercise viewer with Theme Editor (press 'T'), live preview, and no duplicate settings
 * Version: 1.34.0
 * Author: FlexFrame
...
define('FLEXFRAME_VERSION', '1.34.0');
define('FLEXFRAME_PLUGIN_DIR', plugin_dir_path(__FILE__));
define('FLEXFRAME_PLUGIN_URL', plugin_dir_url(__FILE__));

// Log plugin initialization
flexframe_log('Plugin loaded', array('version' => '1.34.0', 'plugin_url' => plugin_dir_url(__FILE__)));
