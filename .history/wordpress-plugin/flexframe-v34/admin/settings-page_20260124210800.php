...
function flexframe_settings_page() {
                        ...
                        <div class="flexframe-custom-panel">
                            ...
                            <div style="padding: 20px; background: #e7f3ff; border-left: 4px solid #0073aa; margin-bottom: 20px;">
                                <p style="margin: 0; font-size: 14px;">
                                    <strong><?php _e('ðŸ’¡ Theme Editor Available:', 'flexframe-viewer'); ?></strong>
                            ...
                            <div class="custom-panel-section">
                                ...
                                <div class="custom-panel-content" id="background-settings-content">
                                    <div class="flexframe-custom-settings">
                                        ...
                                        <p class="description">
                                            <?php _e('ðŸ’¡ Customize the gradient background of the 3D scene.', 'flexframe-viewer'); ?>
                                        </p>
                                        ...
                                        <div class="flexframe-bg-logo-options" id="bg_logo_options" style="<?php echo ($bg_logo_enabled && !empty($logo_url)) ? '' : 'display:none;'; ?>">
                                            ...
                                            <p class="description">
                                                <?php _e('ðŸ’¡ The watermark appears as an overlay on the viewer. Adjust position and opacity to your preference.', 'flexframe-viewer'); ?>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="custom-panel-section">
                                ...
                                <div class="custom-panel-content" id="lighting-settings-content">
                                    <div class="flexframe-custom-settings">
                                        ...
                                        <p class="description">
                                            <?php _e('ðŸ’¡ Adjust lighting to highlight muscle definition and create dramatic effects.', 'flexframe-viewer'); ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="custom-panel-section">
                                ...
                                <div class="custom-panel-content" id="particles-settings-content">
                                    <div class="flexframe-custom-settings">
                                        ...
                                        <p class="description">
                                            <?php _e('ðŸ’¡ Floating dust particles add atmosphere and depth to the scene.', 'flexframe-viewer'); ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    jQuery(document).ready(function($) {
        console.log('FlexFrame admin script loaded');
        console.log('Toggle preview button exists:', $('#toggle-preview-btn').length);
        console.log('Preview container exists:', $('#live-preview-container').length);
        ...
        $('#toggle-preview-btn').on('click', function(e) {
            ...
            console.log('Button:', $button.length, 'Container:', $container.length);
