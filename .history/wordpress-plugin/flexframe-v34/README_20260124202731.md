# FlexFrame Exercise Viewer v34 - WordPress Plugin

Interactive 3D exercise viewer with Theme Editor, live preview, and streamlined settings.

## Version 1.34.0 Changes (January 24, 2026)
- **Theme Editor Integration**: Press 'T' in viewer to access live theme editing
- **Live Preview in Settings**: Step 5 now includes iframe preview with Theme Editor access
- **Removed Duplicate Settings**: UI Settings and Model Materials moved exclusively to Theme Editor
- **Streamlined Step 5**: Only Background, Lighting, and Particles settings remain in WordPress admin
- **Improved UX**: Blue tip box directs users to Theme Editor, eliminating confusion from duplicate settings
