# FlexFrame Exercise Viewer v25 - WordPress Plugin

A 3D interactive exercise viewer plugin for WordPress with customizable logo and materials.

## Version 1.25.0 Changes
- Fixed dropdown menu positioning for left-side menus (Exercises, Muscles, Equipment, Search)
- Fixed dropdown menu positioning for right-side menus (Info panels)
- All dropdowns now use `position: fixed` to ensure consistent positioning regardless of which button is clicked
- Added proper CSS isolation for right-side menu container
