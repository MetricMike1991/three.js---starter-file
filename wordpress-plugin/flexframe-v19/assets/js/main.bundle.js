...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:zn,depthTest:!1,depthWrite:!1})}function Pl(){return new Vn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:vo(),fragmentShader:`
		...
		`,blending:zn,depthTest:!1,depthWrite:!1})}function Ll(){return new Vn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:vo(),fragmentShader:`
...
`].filter(rs).join(`
`)),a=$a(a),a=Vl(a,t),a=Gl(a,t),o=$a(o),o=Vl(o,t),o=Gl(o,t),a=Wl(a),o=Wl(o),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
//# sourceMappingURL=index-CttVUB0b.js.map
