...
define('FLEXFRAME_VERSION', '1.9.9');
...
function flexframe_enqueue_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            /* Hide any duplicate menus outside our container */
            body > .thumbnail-grid-container,
            .site-content > .thumbnail-grid-container,
            .entry-content > .thumbnail-grid-container:not(#flexframe-viewer-container .thumbnail-grid-container) {
                display: none !important;
            }
        ';
        ...
        wp_localize_script('flexframe-viewer-script', 'flexframeSettings', array(
            ...
            'wpSkinPreset' => (bool) $wp_skin_preset, // Ensure boolean
