...
`:"";t.isRawShaderMaterial?(m=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,y].filter(hs).join(`
`),m.length>0&&(m+=`
`),p=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,y].filter(hs).join(`
`),p.length>0&&(p+=`
...
`].filter(hs).join(`
`)),o=ta(o),o=ql(o,t),o=Xl(o,t),a=ta(a),a=ql(a,t),a=Xl(a,t),o=Yl(o),a=Yl(a),t.isRawShaderMaterial!==!0&&(v=`#version 300 es
