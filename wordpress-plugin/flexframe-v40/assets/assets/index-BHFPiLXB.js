...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:zn,depthTest:!1,depthWrite:!1})}function Fl(){return new Vn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ia(),fragmentShader:`
		...
		`,blending:zn,depthTest:!1,depthWrite:!1})}function Ul(){return new Vn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ia(),fragmentShader:`
...
`)}function Fg(r,e){let t;switch(e){case Ih:t="Linear";break;case Dh:t="Reinhard";break;case Ph:t="Cineon";break;case pc:t="ACESFilmic";break;case Bh:t="AgX";break;case Fh:t="Neutral";break;case Lh:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const $s=new P;function Ug(){Qe.getLuminanceCoefficients($s);const r=$s.x.toFixed(4),e=$s.y.toFixed(4),t=$s.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function Qg(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===hc?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===dc?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Sn&&(e="SHADOWMAP_TYPE_VSM"),e}function qg(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Fi:case Ui:e="ENVMAP_TYPE_CUBE";break;case Sr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Yg(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Ui:e="ENVMAP_MODE_REFRACTION";break}return e}function jg(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case uc:e="ENVMAP_BLENDING_MULTIPLY";break;case Ch:e="ENVMAP_BLENDING_MIX";break;case Rh:e="ENVMAP_BLENDING_ADD";break}return e}function Xg(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Kg(r,e,t,n){const i=r.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Qg(t),c=qg(t),h=Yg(t),d=jg(t),u=Xg(t),f=Ng(t),g=Og(s),A=i.createProgram();let m,p,v=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const M=v+m+o,y=v+p+a,C=Wl(i,i.VERTEX_SHADER,M),I=Wl(i,i.FRAGMENT_SHADER,y);i.attachShader(A,C),i.attachShader(A,I),t.index0AttributeName!==void 0?i.bindAttribLocation(A,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(A,0,"position"),i.linkProgram(A);function T(R){if(r.debug.checkShaderErrors){const k=i.getProgramInfoLog(A).trim(),U=i.getShaderInfoLog(C).trim(),z=i.getShaderInfoLog(I).trim();let Q=!0,G=!0;if(i.getProgramParameter(A,i.LINK_STATUS)===!1)if(Q=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,A,C,I);else{const K=ql(i,C,"vertex"),V=ql(i,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(A,i.VALIDATE_STATUS)+`
...
//# sourceMappingURL=index-BHFPiLXB.js.map
