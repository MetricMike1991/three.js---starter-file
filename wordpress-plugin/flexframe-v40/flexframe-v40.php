    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'flexframe_viewer')) {
        ...
        $isolation_css = '
            ...
            @media screen and (min-width: 481px) {
                /* Left side menu container and all children */
                #flexframe-viewer-container .thumbnail-grid-container,
                #flexframe-viewer-container .thumbnail-grid-container *,
                .thumbnail-grid-container,
                .thumbnail-grid-container *,
                
                /* Right side menu container and all children */
                #flexframe-viewer-container .thumbnail-grid-container-right,
                #flexframe-viewer-container .thumbnail-grid-container-right *,
                .thumbnail-grid-container-right,
                .thumbnail-grid-container-right *,
                ...
                /* Menu wrappers */
                #flexframe-viewer-container .thumbnail-menu-wrapper,
                .thumbnail-menu-wrapper,
                ...
                #flexframe-viewer-container .thumbnail-scroll-controls,
                .thumbnail-scroll-controls,
                
                /* Grids */
                #flexframe-viewer-container .thumbnail-grid,
                .thumbnail-grid,
                #searchGrid, #exercisesGrid, #musclesGrid, #equipmentGrid,
                #info1Grid, #info2Grid, #info3Grid, #info4Grid,
                
                /* Search elements */
                #flexframe-viewer-container .search-header,
                .search-header,
                #flexframe-viewer-container .search-content-wrapper,
                .search-content-wrapper,
                #flexframe-viewer-container .search-filters-panel,
                .search-filters-panel,
                #flexframe-viewer-container .search-results-panel,
                .search-results-panel,
                #flexframe-viewer-container .search-input-wrapper,
                .search-input-wrapper,
                #searchInput, #searchActionBtn,
                
                /* Filter elements */
                #flexframe-viewer-container .filter-section,
                .filter-section,
                #flexframe-viewer-container .filter-options,
                .filter-options,
                #typeFilters, #muscleFilters, #equipmentFilters,
