...
`)+`
`+p);const E=b+m+o,y=b+p+a,C=Gl(i,i.VERTEX_SHADER,E),P=Gl(i,i.FRAGMENT_SHADER,y);i.attachShader(g,C),i.attachShader(g,P),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function A(R){if(r.debug.checkShaderErrors){const k=i.getProgramInfoLog(g).trim(),N=i.getShaderInfoLog(C).trim(),H=i.getShaderInfoLog(P).trim();let $=!0,V=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if($=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,g,C,P);else{const K=$l(i,C,"vertex"),G=$l(i,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
...
//# sourceMappingURL=index-OXePbmuX.js.map
