...
export class ARHandler {
     ...
     * @param {object} config - Exercise config from JSON
     * @param {string} thumbnailUrl - Exercise thumbnail image URL
     */
    updateConfig(config, thumbnailUrl) {
        this.currentConfig = config;
        this.thumbnailUrl = thumbnailUrl || null;
        console.log('[FlexFrame AR] Config updated:', config?.ar, 'thumbnail:', thumbnailUrl);
    }
    ...
    generateARPageUrl() {
        ...
        if (this.thumbnailUrl) {
            arParams.set('thumb', this.thumbnailUrl);
        }
